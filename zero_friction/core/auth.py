"""Authentication helpers for the Zero Friction API."""
...
def get_oauth_token() -> str:
    """
    Retrieve an OAuth access token using the client credentials flow.
...
def get_oauth_response() -> tuple[dict[str, Any], str]:
    """
    Retrieve the full OAuth token response and access token.
