...
class EstimatedConsumptionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["startDateTime", "endDateTime", "origin", "lastRecalculated", "consumerGroupId", "contractId", "value"]
