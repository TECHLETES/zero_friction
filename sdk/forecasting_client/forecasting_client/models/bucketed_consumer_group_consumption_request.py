...
class BucketedConsumerGroupConsumptionRequest(BaseModel):
    """
    BucketedConsumerGroupConsumptionRequest
    """ # noqa: E501
    contract_id: Optional[StrictStr] = Field(alias="contractId")
    buckets: Optional[List[DateRange]]
    utility_type: UtilityType = Field(alias="utilityType")
    unit_of_measure: UnitOfMeasure = Field(alias="unitOfMeasure")
    __properties: ClassVar[List[str]] = ["contractId", "buckets", "utilityType", "unitOfMeasure"]
