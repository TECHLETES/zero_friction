...
class PropertyGroupForecastingConfigurationDTO(BaseModel):
    """
    ...
    consumer_groups: Optional[Dict[str, ConsumerGroupReference]] = Field(default=None, alias="consumerGroups")
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "consumerGroups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in consumer_groups (dict)
        _field_dict = {}
        if self.consumer_groups:
            for _key_consumer_groups in self.consumer_groups:
                if self.consumer_groups[_key_consumer_groups]:
                    _field_dict[_key_consumer_groups] = self.consumer_groups[_key_consumer_groups].to_dict()
            _dict['consumerGroups'] = _field_dict
        ...
        # set to None if consumer_groups (nullable) is None
        # and model_fields_set contains the field
        if self.consumer_groups is None and "consumer_groups" in self.model_fields_set:
            _dict['consumerGroups'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consumerGroups": dict(
                (_k, ConsumerGroupReference.from_dict(_v))
                for _k, _v in obj["consumerGroups"].items()
            )
            if obj.get("consumerGroups") is not None
            else None
        })
        return _obj
