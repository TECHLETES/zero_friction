...
class EntityTagHeaderValue(BaseModel):
    ...
    is_weak: Optional[StrictBool] = Field(default=None, alias="isWeak")
    __properties: ClassVar[List[str]] = ["tag", "isWeak"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tag": StringSegment.from_dict(obj["tag"]) if obj.get("tag") is not None else None,
            "isWeak": obj.get("isWeak")
        })
        return _obj
