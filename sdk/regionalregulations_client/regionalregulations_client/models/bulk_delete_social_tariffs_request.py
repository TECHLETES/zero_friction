...
class BulkDeleteSocialTariffsRequest(BaseModel):
    """
    BulkDeleteSocialTariffsRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[ReadExportsQueryParams] = Field(default=None, alias="queryParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": ReadExportsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
