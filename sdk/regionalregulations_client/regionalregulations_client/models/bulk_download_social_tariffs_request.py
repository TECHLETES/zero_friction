...
class BulkDownloadSocialTariffsRequest(BaseModel):
    """
    BulkDownloadSocialTariffsRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[BaseQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    social_tariff_ids: Optional[List[StrictStr]] = Field(default=None, alias="socialTariffIds")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "socialTariffIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": BaseQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
