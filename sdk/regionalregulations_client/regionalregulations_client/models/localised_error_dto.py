...
class LocalisedErrorDTO(BaseModel):
    """
    LocalisedErrorDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["key", "correlationId", "message", "messageValues"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in message_values (list)
        _items = []
        if self.message_values:
            for _item_message_values in self.message_values:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageValues": [LocalisedErrorDTOMessageValue.from_dict(_item) for _item in obj["messageValues"]] if obj.get("messageValues") is not None else None
        })
        return _obj
