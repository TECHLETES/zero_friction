...
class SocialTariffExportDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["startDateTime", "endDateTime", "generated", "internalFilePath", "filename", "type", "onlyMutations", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
