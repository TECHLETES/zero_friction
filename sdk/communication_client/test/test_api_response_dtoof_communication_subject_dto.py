...
class TestApiResponseDTOOfCommunicationSubjectDTO(unittest.TestCase):
    """ApiResponseDTOOfCommunicationSubjectDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfCommunicationSubjectDTO:
        """Test ApiResponseDTOOfCommunicationSubjectDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfCommunicationSubjectDTO`
        """
        model = ApiResponseDTOOfCommunicationSubjectDTO()
        if include_optional:
            return ApiResponseDTOOfCommunicationSubjectDTO(
                data = communication_client.models.communication_subject_dto.CommunicationSubjectDTO(
                    id = '', 
                    subject_type = 'none', 
                    subject_sub_type = '', 
                    subject_id = '', 
    ...
    def testApiResponseDTOOfCommunicationSubjectDTO(self):
        """Test ApiResponseDTOOfCommunicationSubjectDTO"""
