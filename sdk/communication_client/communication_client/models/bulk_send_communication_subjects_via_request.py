...
class BulkSendCommunicationSubjectsViaRequest(BaseModel):
    """
    BulkSendCommunicationSubjectsViaRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[GetCommunicationSubjectsQueryParams] = Field(default=None, alias="queryParams")
    ...
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "forcedCommunicationType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetCommunicationSubjectsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
