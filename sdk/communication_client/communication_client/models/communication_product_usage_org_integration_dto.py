...
class CommunicationProductUsageOrgIntegrationDTO(BaseModel):
    """
    CommunicationProductUsageOrgIntegrationDTO
    """ # noqa: E501
    organization_id: Optional[StrictStr] = Field(default=None, alias="organizationId")
    organization_code: Optional[StrictStr] = Field(default=None, alias="organizationCode")
    organization_name: Optional[StrictStr] = Field(default=None, alias="organizationName")
    integrations: Optional[List[CommunicationProductUsageIntegrationDTO]] = None
    __properties: ClassVar[List[str]] = ["organizationId", "organizationCode", "organizationName", "integrations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizationCode": obj.get("organizationCode"),
            "organizationName": obj.get("organizationName"),
            "integrations": [CommunicationProductUsageIntegrationDTO.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
