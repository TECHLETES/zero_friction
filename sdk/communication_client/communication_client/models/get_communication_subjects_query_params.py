...
class GetCommunicationSubjectsQueryParams(BaseModel):
    """
    ...
    entity_subject_types: Optional[List[StrictStr]] = Field(default=None, alias="entitySubjectTypes")
    entity_subject_sub_types: Optional[List[StrictStr]] = Field(default=None, alias="entitySubjectSubTypes")
    ...
    show_ignored: Optional[StrictBool] = Field(default=None, alias="showIgnored")
    ...
    __properties: ClassVar[List[str]] = ["communicationType", "excludeCommunicationType", "excludeCommunicationEntryStatus", "communicationEntryStatus", "entitySubjectTypes", "entitySubjectSubTypes", "entitySubjectId", "failureReasonCode", "sentStartDateTimeOffset", "sentEndDateTimeOffset", "customerId", "applyFiltersOverIncludedIds", "showIgnored", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entitySubjectTypes": obj.get("entitySubjectTypes"),
            "entitySubjectSubTypes": obj.get("entitySubjectSubTypes"),
            ...
            "showIgnored": obj.get("showIgnored"),
