...
class GetCommunicationProviderAccountsQueryParams(BaseModel):
    """
    GetCommunicationProviderAccountsQueryParams
    """ # noqa: E501
    status: Optional[List[StrictStr]] = None
    provider_type: Optional[List[StrictStr]] = Field(default=None, alias="providerType")
    ...
    __properties: ClassVar[List[str]] = ["status", "providerType", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
