...
class CommunicationProviderAccountDTO(BaseModel):
    """
    CommunicationProviderAccountDTO
    """ # noqa: E501
    provider: Optional[CommunicationProviderType] = None
    status: Optional[CommunicationProviderAccountStatus] = None
    ...
    __properties: ClassVar[List[str]] = ["provider", "status", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
