...
class SubjectReferenceParametersDTOMoveRequestSubjectReferenceParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "moveRequestType", "moveRequestNumber"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MoveRequest']):
            raise ValueError("must be one of enum values ('MoveRequest')")
        return value
