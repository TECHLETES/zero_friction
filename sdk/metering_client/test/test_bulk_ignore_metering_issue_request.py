...
class TestBulkIgnoreMeteringIssueRequest(unittest.TestCase):
    """BulkIgnoreMeteringIssueRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkIgnoreMeteringIssueRequest:
        """Test BulkIgnoreMeteringIssueRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkIgnoreMeteringIssueRequest`
        """
    ...
    def testBulkIgnoreMeteringIssueRequest(self):
        """Test BulkIgnoreMeteringIssueRequest"""
