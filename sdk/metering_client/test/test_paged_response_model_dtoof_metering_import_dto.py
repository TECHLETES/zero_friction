...
class TestPagedResponseModelDTOOfMeteringImportDTO(unittest.TestCase):
    """PagedResponseModelDTOOfMeteringImportDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfMeteringImportDTO:
        """Test PagedResponseModelDTOOfMeteringImportDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfMeteringImportDTO`
        """
        model = PagedResponseModelDTOOfMeteringImportDTO()
        if include_optional:
            return PagedResponseModelDTOOfMeteringImportDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfMeteringImportDTO(self):
        """Test PagedResponseModelDTOOfMeteringImportDTO"""
