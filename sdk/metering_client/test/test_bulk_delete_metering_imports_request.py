...
class TestBulkDeleteMeteringImportsRequest(unittest.TestCase):
    """BulkDeleteMeteringImportsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteMeteringImportsRequest:
        """Test BulkDeleteMeteringImportsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteMeteringImportsRequest`
        """
        model = BulkDeleteMeteringImportsRequest()
        if include_optional:
    ...
    def testBulkDeleteMeteringImportsRequest(self):
        """Test BulkDeleteMeteringImportsRequest"""
