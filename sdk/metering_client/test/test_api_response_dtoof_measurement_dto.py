...
class TestApiResponseDTOOfMeasurementDTO(unittest.TestCase):
    """ApiResponseDTOOfMeasurementDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfMeasurementDTO:
        """Test ApiResponseDTOOfMeasurementDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfMeasurementDTO`
        """
        model = ApiResponseDTOOfMeasurementDTO()
        if include_optional:
            return ApiResponseDTOOfMeasurementDTO(
                data = metering_client.models.measurement_dto.MeasurementDTO(
    ...
    def testApiResponseDTOOfMeasurementDTO(self):
        """Test ApiResponseDTOOfMeasurementDTO"""
