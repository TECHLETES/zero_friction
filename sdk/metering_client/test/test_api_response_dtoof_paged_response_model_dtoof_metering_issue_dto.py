...
class TestApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO(unittest.TestCase):
    """ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO:
        """Test ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO`
        """
        model = ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO()
        if include_optional:
            return ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO(
                data = metering_client.models.paged_response_model_dtoof_metering_issue_dto.PagedResponseModelDTOOfMeteringIssueDTO(
                    results = [
    ...
    def testApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO(self):
        """Test ApiResponseDTOOfPagedResponseModelDTOOfMeteringIssueDTO"""
