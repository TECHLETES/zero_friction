...
class MeteringProviderAccountDTOFortesMeteringProviderAccountDTO(BaseModel):
    """
    MeteringProviderAccountDTOFortesMeteringProviderAccountDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="__type")
    authentication_api_token: Optional[StrictStr] = Field(default=None, alias="authenticationApiToken")
    ...
    __properties: ClassVar[List[str]] = ["__type", "authenticationApiToken", "providerType", "cronExpression", "status", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['FortesMeteringProviderAccountDTO']):
            raise ValueError("must be one of enum values ('FortesMeteringProviderAccountDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authenticationApiToken": obj.get("authenticationApiToken"),
