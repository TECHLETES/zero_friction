...
class MeteringProviderAccountDTOEnergyGripMeteringProviderAccountDTO(BaseModel):
    """
    ...
    environment: Optional[EnergyGripEnvironment] = None
    ...
    __properties: ClassVar[List[str]] = ["__type", "username", "environment", "providerType", "cronExpression", "status", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['EnergyGripMeteringProviderAccountDTO']):
            raise ValueError("must be one of enum values ('EnergyGripMeteringProviderAccountDTO')")
        return value
