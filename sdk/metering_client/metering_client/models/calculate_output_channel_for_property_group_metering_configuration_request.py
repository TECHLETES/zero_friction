...
class CalculateOutputChannelForPropertyGroupMeteringConfigurationRequest(BaseModel):
    """
    ...
    simulation_only: Optional[StrictBool] = Field(default=None, alias="simulationOnly")
    __properties: ClassVar[List[str]] = ["startDateTime", "endDateTime", "simulationOnly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "simulationOnly": obj.get("simulationOnly")
        })
        return _obj
