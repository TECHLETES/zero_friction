...
class MeteringProviderRunDTO(BaseModel):
    """
    ...
    status: Optional[MeteringProviderRunStatus] = None
    errors: Optional[List[MeteringProviderRunErrorDTO]] = None
    ...
    __properties: ClassVar[List[str]] = ["providerType", "providerId", "status", "errors", "completedDate", "startedDate", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [MeteringProviderRunErrorDTO.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
