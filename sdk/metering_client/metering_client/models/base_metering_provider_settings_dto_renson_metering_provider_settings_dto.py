...
class BaseMeteringProviderSettingsDTORensonMeteringProviderSettingsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["__type", "username", "password", "utilityTypes"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Renson']):
            raise ValueError("must be one of enum values ('Renson')")
        return value
