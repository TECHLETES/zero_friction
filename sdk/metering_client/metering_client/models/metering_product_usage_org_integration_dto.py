...
class MeteringProductUsageOrgIntegrationDTO(BaseModel):
    """
    ...
    integrations: Optional[List[MeteringProductUsageIntegrationDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "integrations": [MeteringProductUsageIntegrationDTO.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
