...
class GetMeasurementsQueryParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["externalChannelIdentifier", "startDateTime", "endDateTime", "showInvalid", "dataFrequency", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
