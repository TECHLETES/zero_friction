...
class PrepaymentTransactionDTO(BaseModel):
    """
    ...
    channel_identfier: Optional[StrictStr] = Field(default=None, alias="channelIdentfier")
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "meter", "channelIdentfier", "customerId", "contractId", "processedDateTime", "amount", "type", "origin", "status", "externalReference", "operationId", "deleted"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if channel_identfier (nullable) is None
        # and model_fields_set contains the field
        if self.channel_identfier is None and "channel_identfier" in self.model_fields_set:
            _dict['channelIdentfier'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "channelIdentfier": obj.get("channelIdentfier"),
