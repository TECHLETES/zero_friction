...
class ExportConsumptionsForMetersRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["queryParams", "quickFilter", "meterIds", "startDateTime", "endDateTime", "onlyValidate"]
