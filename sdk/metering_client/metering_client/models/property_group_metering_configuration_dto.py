...
class PropertyGroupMeteringConfigurationDTO(BaseModel):
    """
    ...
    output_channels: Optional[List[OutputChannelDTO]] = Field(default=None, alias="outputChannels")
    validated: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "propertyGroup", "outputChannels", "validated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputChannels": [OutputChannelDTO.from_dict(_item) for _item in obj["outputChannels"]] if obj.get("outputChannels") is not None else None,
