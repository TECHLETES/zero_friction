...
class FlatPagedConsumptionDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["externalChannelIdentifier", "complete", "userId", "productionDay", "productionDayStartUtc", "productionDayEndUtc", "startDateTime", "endDateTime", "value"]
