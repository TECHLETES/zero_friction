...
class AverageServiceConsumptionPerServiceLocationDTO(BaseModel):
    """
    AverageServiceConsumptionPerServiceLocationDTO
    """ # noqa: E501
    total: Optional[Union[StrictFloat, StrictInt]] = None
    amount_of_days: Optional[StrictInt] = Field(default=None, alias="amountOfDays")
    ...
    average_per_year: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="averagePerYear")
    period: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total", "amountOfDays", "utilityType", "unitOfMeasure", "serviceLocationId", "averagePerYear", "period"]
