...
class ServiceConsumptionSumRequest(BaseModel):
    """
    ...
    sum_by_utility_type: Optional[StrictBool] = Field(default=None, alias="sumByUtilityType")
    __properties: ClassVar[List[str]] = ["locationIds", "quickFilter", "startDateTime", "endDateTime", "sumByUtilityType"]
