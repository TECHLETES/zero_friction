...
class ImportedMeasurementsOverviewDTO(BaseModel):
    """
    ...
    total_measurements_processed: Optional[StrictInt] = Field(default=None, alias="totalMeasurementsProcessed")
    total_lines_with_format_issues: Optional[StrictInt] = Field(default=None, alias="totalLinesWithFormatIssues")
    __properties: ClassVar[List[str]] = ["measurements", "totalInvalidMeasurements", "totalValidMeasurements", "totalMeasurementsNotProcessed", "totalMeasurementsProcessed", "totalLinesWithFormatIssues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalMeasurementsProcessed": obj.get("totalMeasurementsProcessed"),
