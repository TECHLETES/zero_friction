...
class AggregateDetailsDTO(BaseModel):
    """
    AggregateDetailsDTO
    """ # noqa: E501
    ...
    value_date: Optional[datetime] = Field(default=None, alias="valueDate")
    __properties: ClassVar[List[str]] = ["code", "translation", "value", "valueDate"]
