...
class BaseMeteringIssueDetailsDTOMissingConsumptionMeteringIssueDetailsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "startDateTime", "measurementId", "value", "unitOfMeasure", "endDateTime", "externalChannelIdentifier", "resolvedValue", "readingOrigin", "readingMethod", "originDetails", "calculatedConsumption", "estimatedConsumption", "upperBound", "lowerBound"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['BaseMeteringIssueDetailsDTO:Measurement:MissingConsumptionMeteringIssueDetailsDTO']):
            raise ValueError("must be one of enum values ('BaseMeteringIssueDetailsDTO:Measurement:MissingConsumptionMeteringIssueDetailsDTO')")
        return value
