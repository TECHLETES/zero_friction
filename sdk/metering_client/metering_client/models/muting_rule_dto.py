...
class MutingRuleDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["errorType", "message", "timePeriod", "muteFrom", "muteUntil", "meterId", "muteFromWithNumericValue", "muteUntilWithNumericValue", "userId", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
