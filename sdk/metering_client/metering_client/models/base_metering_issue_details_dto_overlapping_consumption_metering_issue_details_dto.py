...
class BaseMeteringIssueDetailsDTOOverlappingConsumptionMeteringIssueDetailsDTO(BaseModel):
    """
    ...
    overlapping_start_date_time: Optional[datetime] = Field(default=None, alias="overlappingStartDateTime")
    overlapping_end_date_time: Optional[datetime] = Field(default=None, alias="overlappingEndDateTime")
    overlapping_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="overlappingValue")
    overlapping_unit_of_measure: Optional[UnitOfMeasure] = Field(default=None, alias="overlappingUnitOfMeasure")
    ...
    __properties: ClassVar[List[str]] = ["type", "startDateTime", "overlappingStartDateTime", "overlappingEndDateTime", "overlappingValue", "overlappingUnitOfMeasure", "measurementId", "value", "unitOfMeasure", "endDateTime", "externalChannelIdentifier", "resolvedValue", "readingOrigin", "readingMethod", "originDetails", "calculatedConsumption", "estimatedConsumption", "upperBound", "lowerBound"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['BaseMeteringIssueDetailsDTO:Measurement:OverlappingConsumptionMeteringIssueDetailsDTO']):
            raise ValueError("must be one of enum values ('BaseMeteringIssueDetailsDTO:Measurement:OverlappingConsumptionMeteringIssueDetailsDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overlappingStartDateTime": obj.get("overlappingStartDateTime"),
            "overlappingEndDateTime": obj.get("overlappingEndDateTime"),
            "overlappingValue": obj.get("overlappingValue"),
            "overlappingUnitOfMeasure": obj.get("overlappingUnitOfMeasure"),
