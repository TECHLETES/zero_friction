# PaymentPlanActivatedScenarioDTO
...
json = "{}"
# create an instance of PaymentPlanActivatedScenarioDTO from a JSON string
payment_plan_activated_scenario_dto_instance = PaymentPlanActivatedScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(PaymentPlanActivatedScenarioDTO.to_json())

# convert the object into a dict
payment_plan_activated_scenario_dto_dict = payment_plan_activated_scenario_dto_instance.to_dict()
# create an instance of PaymentPlanActivatedScenarioDTO from a dict
payment_plan_activated_scenario_dto_from_dict = PaymentPlanActivatedScenarioDTO.from_dict(payment_plan_activated_scenario_dto_dict)
```
