# IScenarioDTOReminderScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOReminderScenarioDTO from a JSON string
i_scenario_dto_reminder_scenario_dto_instance = IScenarioDTOReminderScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOReminderScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_reminder_scenario_dto_dict = i_scenario_dto_reminder_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOReminderScenarioDTO from a dict
i_scenario_dto_reminder_scenario_dto_from_dict = IScenarioDTOReminderScenarioDTO.from_dict(i_scenario_dto_reminder_scenario_dto_dict)
```
