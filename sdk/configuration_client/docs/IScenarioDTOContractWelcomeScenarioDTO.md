# IScenarioDTOContractWelcomeScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOContractWelcomeScenarioDTO from a JSON string
i_scenario_dto_contract_welcome_scenario_dto_instance = IScenarioDTOContractWelcomeScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOContractWelcomeScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_contract_welcome_scenario_dto_dict = i_scenario_dto_contract_welcome_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOContractWelcomeScenarioDTO from a dict
i_scenario_dto_contract_welcome_scenario_dto_from_dict = IScenarioDTOContractWelcomeScenarioDTO.from_dict(i_scenario_dto_contract_welcome_scenario_dto_dict)
```
