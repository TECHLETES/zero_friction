# IScenarioDTONoticeOfDefaultScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTONoticeOfDefaultScenarioDTO from a JSON string
i_scenario_dto_notice_of_default_scenario_dto_instance = IScenarioDTONoticeOfDefaultScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTONoticeOfDefaultScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_notice_of_default_scenario_dto_dict = i_scenario_dto_notice_of_default_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTONoticeOfDefaultScenarioDTO from a dict
i_scenario_dto_notice_of_default_scenario_dto_from_dict = IScenarioDTONoticeOfDefaultScenarioDTO.from_dict(i_scenario_dto_notice_of_default_scenario_dto_dict)
```
