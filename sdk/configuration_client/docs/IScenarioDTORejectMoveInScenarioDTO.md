# IScenarioDTORejectMoveInScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTORejectMoveInScenarioDTO from a JSON string
i_scenario_dto_reject_move_in_scenario_dto_instance = IScenarioDTORejectMoveInScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTORejectMoveInScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_reject_move_in_scenario_dto_dict = i_scenario_dto_reject_move_in_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTORejectMoveInScenarioDTO from a dict
i_scenario_dto_reject_move_in_scenario_dto_from_dict = IScenarioDTORejectMoveInScenarioDTO.from_dict(i_scenario_dto_reject_move_in_scenario_dto_dict)
```
