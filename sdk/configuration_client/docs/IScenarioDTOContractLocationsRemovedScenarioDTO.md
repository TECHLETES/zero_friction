# IScenarioDTOContractLocationsRemovedScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOContractLocationsRemovedScenarioDTO from a JSON string
i_scenario_dto_contract_locations_removed_scenario_dto_instance = IScenarioDTOContractLocationsRemovedScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOContractLocationsRemovedScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_contract_locations_removed_scenario_dto_dict = i_scenario_dto_contract_locations_removed_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOContractLocationsRemovedScenarioDTO from a dict
i_scenario_dto_contract_locations_removed_scenario_dto_from_dict = IScenarioDTOContractLocationsRemovedScenarioDTO.from_dict(i_scenario_dto_contract_locations_removed_scenario_dto_dict)
```
