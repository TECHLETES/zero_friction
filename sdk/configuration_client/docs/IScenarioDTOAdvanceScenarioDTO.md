# IScenarioDTOAdvanceScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOAdvanceScenarioDTO from a JSON string
i_scenario_dto_advance_scenario_dto_instance = IScenarioDTOAdvanceScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOAdvanceScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_advance_scenario_dto_dict = i_scenario_dto_advance_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOAdvanceScenarioDTO from a dict
i_scenario_dto_advance_scenario_dto_from_dict = IScenarioDTOAdvanceScenarioDTO.from_dict(i_scenario_dto_advance_scenario_dto_dict)
```
