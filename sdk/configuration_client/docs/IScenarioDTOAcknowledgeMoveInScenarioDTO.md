# IScenarioDTOAcknowledgeMoveInScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOAcknowledgeMoveInScenarioDTO from a JSON string
i_scenario_dto_acknowledge_move_in_scenario_dto_instance = IScenarioDTOAcknowledgeMoveInScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOAcknowledgeMoveInScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_acknowledge_move_in_scenario_dto_dict = i_scenario_dto_acknowledge_move_in_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOAcknowledgeMoveInScenarioDTO from a dict
i_scenario_dto_acknowledge_move_in_scenario_dto_from_dict = IScenarioDTOAcknowledgeMoveInScenarioDTO.from_dict(i_scenario_dto_acknowledge_move_in_scenario_dto_dict)
```
