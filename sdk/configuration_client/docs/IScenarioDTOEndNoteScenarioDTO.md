# IScenarioDTOEndNoteScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOEndNoteScenarioDTO from a JSON string
i_scenario_dto_end_note_scenario_dto_instance = IScenarioDTOEndNoteScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOEndNoteScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_end_note_scenario_dto_dict = i_scenario_dto_end_note_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOEndNoteScenarioDTO from a dict
i_scenario_dto_end_note_scenario_dto_from_dict = IScenarioDTOEndNoteScenarioDTO.from_dict(i_scenario_dto_end_note_scenario_dto_dict)
```
