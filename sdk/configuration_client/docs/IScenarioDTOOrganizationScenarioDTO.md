...
i_scenario_dto_organization_scenario_dto_instance = IScenarioDTOOrganizationScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOOrganizationScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_organization_scenario_dto_dict = i_scenario_dto_organization_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOOrganizationScenarioDTO from a dict
i_scenario_dto_organization_scenario_dto_from_dict = IScenarioDTOOrganizationScenarioDTO.from_dict(i_scenario_dto_organization_scenario_dto_dict)
```
