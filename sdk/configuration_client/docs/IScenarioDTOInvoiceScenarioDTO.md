# IScenarioDTOInvoiceScenarioDTO
...
json = "{}"
# create an instance of IScenarioDTOInvoiceScenarioDTO from a JSON string
i_scenario_dto_invoice_scenario_dto_instance = IScenarioDTOInvoiceScenarioDTO.from_json(json)
# print the JSON string representation of the object
print(IScenarioDTOInvoiceScenarioDTO.to_json())

# convert the object into a dict
i_scenario_dto_invoice_scenario_dto_dict = i_scenario_dto_invoice_scenario_dto_instance.to_dict()
# create an instance of IScenarioDTOInvoiceScenarioDTO from a dict
i_scenario_dto_invoice_scenario_dto_from_dict = IScenarioDTOInvoiceScenarioDTO.from_dict(i_scenario_dto_invoice_scenario_dto_dict)
```
