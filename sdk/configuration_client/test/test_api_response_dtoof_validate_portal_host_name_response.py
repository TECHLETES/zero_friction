...
class TestApiResponseDTOOfValidatePortalHostNameResponse(unittest.TestCase):
    """ApiResponseDTOOfValidatePortalHostNameResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfValidatePortalHostNameResponse:
        """Test ApiResponseDTOOfValidatePortalHostNameResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfValidatePortalHostNameResponse`
        """
        model = ApiResponseDTOOfValidatePortalHostNameResponse()
        if include_optional:
            return ApiResponseDTOOfValidatePortalHostNameResponse(
                data = configuration_client.models.validate_portal_host_name_response.ValidatePortalHostNameResponse(
                    portal_settings = configuration_client.models.portal_settings_dto.PortalSettingsDTO(
                        tenant_id = '', 
                        primary_color = '', 
                        secondary_color = '', 
                        fav_icon = '', 
    ...
    def testApiResponseDTOOfValidatePortalHostNameResponse(self):
        """Test ApiResponseDTOOfValidatePortalHostNameResponse"""
