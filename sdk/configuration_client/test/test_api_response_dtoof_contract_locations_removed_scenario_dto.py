...
class TestApiResponseDTOOfContractLocationsRemovedScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfContractLocationsRemovedScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfContractLocationsRemovedScenarioDTO:
        """Test ApiResponseDTOOfContractLocationsRemovedScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfContractLocationsRemovedScenarioDTO`
        """
        model = ApiResponseDTOOfContractLocationsRemovedScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfContractLocationsRemovedScenarioDTO(
                data = configuration_client.models.contract_locations_removed_scenario_dto.ContractLocationsRemovedScenarioDTO(
    ...
    def testApiResponseDTOOfContractLocationsRemovedScenarioDTO(self):
        """Test ApiResponseDTOOfContractLocationsRemovedScenarioDTO"""
