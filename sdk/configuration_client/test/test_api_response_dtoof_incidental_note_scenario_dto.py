...
class TestApiResponseDTOOfIncidentalNoteScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfIncidentalNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfIncidentalNoteScenarioDTO:
        """Test ApiResponseDTOOfIncidentalNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfIncidentalNoteScenarioDTO`
        """
        model = ApiResponseDTOOfIncidentalNoteScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfIncidentalNoteScenarioDTO(
                data = configuration_client.models.incidental_note_scenario_dto.IncidentalNoteScenarioDTO(
                    pdf_template = configuration_client.models.incidental_note_pdf_template_dto.IncidentalNotePdfTemplateDTO(
                        show_country = True, 
                        show_balance = True, 
                        show_vat_specs = True, 
                    ...
                    email_template = configuration_client.models.incidental_note_email_template_dto.IncidentalNoteEmailTemplateDTO(
                        subject = '', 
                        attachments = [
    ...
    def testApiResponseDTOOfIncidentalNoteScenarioDTO(self):
        """Test ApiResponseDTOOfIncidentalNoteScenarioDTO"""
