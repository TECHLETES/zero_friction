...
class TestReminderPdfTemplateDTO(unittest.TestCase):
    """ReminderPdfTemplateDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderPdfTemplateDTO:
        """Test ReminderPdfTemplateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderPdfTemplateDTO`
        """
    ...
    def testReminderPdfTemplateDTO(self):
        """Test ReminderPdfTemplateDTO"""
