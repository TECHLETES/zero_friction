...
class TestIScenarioDTOAdvanceScenarioDTO(unittest.TestCase):
    """IScenarioDTOAdvanceScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOAdvanceScenarioDTO:
        """Test IScenarioDTOAdvanceScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOAdvanceScenarioDTO`
        """
        model = IScenarioDTOAdvanceScenarioDTO()
        if include_optional:
            return IScenarioDTOAdvanceScenarioDTO(
                type = 'AdvanceScenarioDTO',
    ...
    def testIScenarioDTOAdvanceScenarioDTO(self):
        """Test IScenarioDTOAdvanceScenarioDTO"""
