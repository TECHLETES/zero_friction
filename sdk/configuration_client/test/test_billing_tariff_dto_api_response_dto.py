...
class TestBillingTariffDTOApiResponseDTO(unittest.TestCase):
    """BillingTariffDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingTariffDTOApiResponseDTO:
        """Test BillingTariffDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingTariffDTOApiResponseDTO`
        """
        model = BillingTariffDTOApiResponseDTO()
        if include_optional:
            return BillingTariffDTOApiResponseDTO(
                errors = [
    ...
    def testBillingTariffDTOApiResponseDTO(self):
        """Test BillingTariffDTOApiResponseDTO"""
