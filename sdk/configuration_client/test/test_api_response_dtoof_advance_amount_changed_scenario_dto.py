...
class TestApiResponseDTOOfAdvanceAmountChangedScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfAdvanceAmountChangedScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfAdvanceAmountChangedScenarioDTO:
        """Test ApiResponseDTOOfAdvanceAmountChangedScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfAdvanceAmountChangedScenarioDTO`
        """
        model = ApiResponseDTOOfAdvanceAmountChangedScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfAdvanceAmountChangedScenarioDTO(
                data = configuration_client.models.advance_amount_changed_scenario_dto.AdvanceAmountChangedScenarioDTO(
    ...
    def testApiResponseDTOOfAdvanceAmountChangedScenarioDTO(self):
        """Test ApiResponseDTOOfAdvanceAmountChangedScenarioDTO"""
