...
class TestPaymentPlanReminderScenarioDTO(unittest.TestCase):
    """PaymentPlanReminderScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentPlanReminderScenarioDTO:
        """Test PaymentPlanReminderScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPlanReminderScenarioDTO`
        """
        model = PaymentPlanReminderScenarioDTO()
        if include_optional:
            return PaymentPlanReminderScenarioDTO(
    ...
    def testPaymentPlanReminderScenarioDTO(self):
        """Test PaymentPlanReminderScenarioDTO"""
