...
class TestApiResponseDTOOfContractWelcomeScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfContractWelcomeScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfContractWelcomeScenarioDTO:
        """Test ApiResponseDTOOfContractWelcomeScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfContractWelcomeScenarioDTO`
        """
        model = ApiResponseDTOOfContractWelcomeScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfContractWelcomeScenarioDTO(
                data = configuration_client.models.contract_welcome_scenario_dto.ContractWelcomeScenarioDTO(
                    email_template = configuration_client.models.contract_welcome_email_template_dto.ContractWelcomeEmailTemplateDTO(
                        subject = '', 
                        attachments = [
    ...
    def testApiResponseDTOOfContractWelcomeScenarioDTO(self):
        """Test ApiResponseDTOOfContractWelcomeScenarioDTO"""
