...
class TestNoticeOfDefaultScenarioDTO(unittest.TestCase):
    """NoticeOfDefaultScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoticeOfDefaultScenarioDTO:
        """Test NoticeOfDefaultScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoticeOfDefaultScenarioDTO`
        """
        model = NoticeOfDefaultScenarioDTO()
        if include_optional:
            return NoticeOfDefaultScenarioDTO(
    ...
    def testNoticeOfDefaultScenarioDTO(self):
        """Test NoticeOfDefaultScenarioDTO"""
