...
class TestCorrectionNotePdfTemplateDTO(unittest.TestCase):
    """CorrectionNotePdfTemplateDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorrectionNotePdfTemplateDTO:
        """Test CorrectionNotePdfTemplateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CorrectionNotePdfTemplateDTO`
        """
        model = CorrectionNotePdfTemplateDTO()
        if include_optional:
            return CorrectionNotePdfTemplateDTO(
                file_name = '',
                use_case = 'pdf',
                use_build_in = True,
    ...
    def testCorrectionNotePdfTemplateDTO(self):
        """Test CorrectionNotePdfTemplateDTO"""
