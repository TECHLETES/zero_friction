...
class TestContractWelcomeScenarioDTO(unittest.TestCase):
    """ContractWelcomeScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractWelcomeScenarioDTO:
        """Test ContractWelcomeScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractWelcomeScenarioDTO`
        """
        model = ContractWelcomeScenarioDTO()
        if include_optional:
            return ContractWelcomeScenarioDTO(
    ...
    def testContractWelcomeScenarioDTO(self):
        """Test ContractWelcomeScenarioDTO"""
