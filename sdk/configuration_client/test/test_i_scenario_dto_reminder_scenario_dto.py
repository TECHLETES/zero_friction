...
class TestIScenarioDTOReminderScenarioDTO(unittest.TestCase):
    """IScenarioDTOReminderScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOReminderScenarioDTO:
        """Test IScenarioDTOReminderScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOReminderScenarioDTO`
        """
        model = IScenarioDTOReminderScenarioDTO()
        if include_optional:
            return IScenarioDTOReminderScenarioDTO(
                type = 'ReminderScenarioDTO',
    ...
    def testIScenarioDTOReminderScenarioDTO(self):
        """Test IScenarioDTOReminderScenarioDTO"""
