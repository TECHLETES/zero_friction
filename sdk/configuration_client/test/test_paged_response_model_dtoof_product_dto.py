...
class TestPagedResponseModelDTOOfProductDTO(unittest.TestCase):
    """PagedResponseModelDTOOfProductDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfProductDTO:
        """Test PagedResponseModelDTOOfProductDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfProductDTO`
        """
        model = PagedResponseModelDTOOfProductDTO()
        if include_optional:
            return PagedResponseModelDTOOfProductDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfProductDTO(self):
        """Test PagedResponseModelDTOOfProductDTO"""
