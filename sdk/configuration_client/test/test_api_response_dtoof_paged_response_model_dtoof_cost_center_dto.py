...
class TestApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO(unittest.TestCase):
    """ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO:
        """Test ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO`
        """
        model = ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO()
        if include_optional:
            return ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO(
                data = configuration_client.models.paged_response_model_dtoof_cost_center_dto.PagedResponseModelDTOOfCostCenterDTO(
                    results = [
                        configuration_client.models.cost_center_dto.CostCenterDTO(
                            description = '',
                            code = '',
    ...
    def testApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO(self):
        """Test ApiResponseDTOOfPagedResponseModelDTOOfCostCenterDTO"""
