...
class TestAdvancePdfTemplateDTO(unittest.TestCase):
    """AdvancePdfTemplateDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvancePdfTemplateDTO:
        """Test AdvancePdfTemplateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvancePdfTemplateDTO`
        """
        model = AdvancePdfTemplateDTO()
        if include_optional:
            return AdvancePdfTemplateDTO(
                file_name = '',
                use_case = 'pdf',
                use_build_in = True,
    ...
    def testAdvancePdfTemplateDTO(self):
        """Test AdvancePdfTemplateDTO"""
