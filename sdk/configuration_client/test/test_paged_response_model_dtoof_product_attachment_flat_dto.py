...
class TestPagedResponseModelDTOOfProductAttachmentFlatDTO(unittest.TestCase):
    """PagedResponseModelDTOOfProductAttachmentFlatDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfProductAttachmentFlatDTO:
        """Test PagedResponseModelDTOOfProductAttachmentFlatDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfProductAttachmentFlatDTO`
        """
        model = PagedResponseModelDTOOfProductAttachmentFlatDTO()
        if include_optional:
            return PagedResponseModelDTOOfProductAttachmentFlatDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfProductAttachmentFlatDTO(self):
        """Test PagedResponseModelDTOOfProductAttachmentFlatDTO"""
