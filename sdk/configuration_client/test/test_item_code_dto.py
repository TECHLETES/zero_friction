...
class TestItemCodeDTO(unittest.TestCase):
    """ItemCodeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemCodeDTO:
        """Test ItemCodeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemCodeDTO`
        """
        model = ItemCodeDTO()
        if include_optional:
            return ItemCodeDTO(
