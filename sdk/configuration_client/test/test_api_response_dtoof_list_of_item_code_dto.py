...
class TestApiResponseDTOOfListOfItemCodeDTO(unittest.TestCase):
    """ApiResponseDTOOfListOfItemCodeDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfListOfItemCodeDTO:
        """Test ApiResponseDTOOfListOfItemCodeDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfListOfItemCodeDTO`
        """
        model = ApiResponseDTOOfListOfItemCodeDTO()
        if include_optional:
            return ApiResponseDTOOfListOfItemCodeDTO(
                data = [
    ...
    def testApiResponseDTOOfListOfItemCodeDTO(self):
        """Test ApiResponseDTOOfListOfItemCodeDTO"""
