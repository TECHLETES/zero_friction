...
class TestBasePdfTemplateDTOBase(unittest.TestCase):
    """BasePdfTemplateDTOBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasePdfTemplateDTOBase:
        """Test BasePdfTemplateDTOBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasePdfTemplateDTOBase`
        """
        model = BasePdfTemplateDTOBase()
        if include_optional:
            return BasePdfTemplateDTOBase(
    ...
    def testBasePdfTemplateDTOBase(self):
        """Test BasePdfTemplateDTOBase"""
