...
class TestApiResponseDTOOfListOfCostUnitDTO(unittest.TestCase):
    """ApiResponseDTOOfListOfCostUnitDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfListOfCostUnitDTO:
        """Test ApiResponseDTOOfListOfCostUnitDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfListOfCostUnitDTO`
        """
        model = ApiResponseDTOOfListOfCostUnitDTO()
        if include_optional:
            return ApiResponseDTOOfListOfCostUnitDTO(
                data = [
    ...
    def testApiResponseDTOOfListOfCostUnitDTO(self):
        """Test ApiResponseDTOOfListOfCostUnitDTO"""
