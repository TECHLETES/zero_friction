...
class TestValidatePortalHostNameResponse(unittest.TestCase):
    """ValidatePortalHostNameResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatePortalHostNameResponse:
        """Test ValidatePortalHostNameResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatePortalHostNameResponse`
        """
        model = ValidatePortalHostNameResponse()
        if include_optional:
            return ValidatePortalHostNameResponse(
    ...
    def testValidatePortalHostNameResponse(self):
        """Test ValidatePortalHostNameResponse"""
