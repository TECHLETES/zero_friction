...
class TestApiResponseDTOOfPaymentPlanCancelledScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfPaymentPlanCancelledScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPaymentPlanCancelledScenarioDTO:
        """Test ApiResponseDTOOfPaymentPlanCancelledScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPaymentPlanCancelledScenarioDTO`
        """
        model = ApiResponseDTOOfPaymentPlanCancelledScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfPaymentPlanCancelledScenarioDTO(
                data = configuration_client.models.payment_plan_cancelled_scenario_dto.PaymentPlanCancelledScenarioDTO(
    ...
    def testApiResponseDTOOfPaymentPlanCancelledScenarioDTO(self):
        """Test ApiResponseDTOOfPaymentPlanCancelledScenarioDTO"""
