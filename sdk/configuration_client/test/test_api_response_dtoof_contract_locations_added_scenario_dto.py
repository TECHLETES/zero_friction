...
class TestApiResponseDTOOfContractLocationsAddedScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfContractLocationsAddedScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfContractLocationsAddedScenarioDTO:
        """Test ApiResponseDTOOfContractLocationsAddedScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfContractLocationsAddedScenarioDTO`
        """
        model = ApiResponseDTOOfContractLocationsAddedScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfContractLocationsAddedScenarioDTO(
    ...
    def testApiResponseDTOOfContractLocationsAddedScenarioDTO(self):
        """Test ApiResponseDTOOfContractLocationsAddedScenarioDTO"""
