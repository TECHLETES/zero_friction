...
class TestIScenarioDTOIncidentalNoteScenarioDTO(unittest.TestCase):
    """IScenarioDTOIncidentalNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOIncidentalNoteScenarioDTO:
        """Test IScenarioDTOIncidentalNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOIncidentalNoteScenarioDTO`
        """
        model = IScenarioDTOIncidentalNoteScenarioDTO()
        if include_optional:
            return IScenarioDTOIncidentalNoteScenarioDTO(
                type = 'IncidentalNoteScenarioDTO',
    ...
    def testIScenarioDTOIncidentalNoteScenarioDTO(self):
        """Test IScenarioDTOIncidentalNoteScenarioDTO"""
