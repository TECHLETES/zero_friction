...
class TestStringApiResponseDTO(unittest.TestCase):
    """StringApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StringApiResponseDTO:
        """Test StringApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StringApiResponseDTO`
        """
        model = StringApiResponseDTO()
        if include_optional:
            return StringApiResponseDTO(
                errors = [
    ...
    def testStringApiResponseDTO(self):
        """Test StringApiResponseDTO"""
