...
class TestInvoiceScenarioDTO(unittest.TestCase):
    """InvoiceScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceScenarioDTO:
        """Test InvoiceScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceScenarioDTO`
        """
    ...
    def testInvoiceScenarioDTO(self):
        """Test InvoiceScenarioDTO"""
