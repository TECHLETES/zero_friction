...
class TestOrganizationDTOApiResponseDTO(unittest.TestCase):
    """OrganizationDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationDTOApiResponseDTO:
        """Test OrganizationDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationDTOApiResponseDTO`
        """
        model = OrganizationDTOApiResponseDTO()
        if include_optional:
            return OrganizationDTOApiResponseDTO(
                errors = [
    ...
    def testOrganizationDTOApiResponseDTO(self):
        """Test OrganizationDTOApiResponseDTO"""
