...
class TestApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO:
        """Test ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO`
        """
        model = ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO(
                data = configuration_client.models.payment_plan_recalculated_scenario_dto.PaymentPlanRecalculatedScenarioDTO(
                    email_template = configuration_client.models.payment_plan_recalculated_email_template_dto.PaymentPlanRecalculatedEmailTemplateDTO(
                        subject = '',
                        attachments = [
                    ...
                    pdf_template = configuration_client.models.payment_plan_recalculated_pdf_template_dto.PaymentPlanRecalculatedPdfTemplateDTO(
                        show_country = True,
    ...
    def testApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO(self):
        """Test ApiResponseDTOOfPaymentPlanRecalculatedScenarioDTO"""
