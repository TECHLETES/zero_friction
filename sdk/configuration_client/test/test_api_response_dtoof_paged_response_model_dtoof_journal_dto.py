...
class TestApiResponseDTOOfPagedResponseModelDTOOfJournalDto(unittest.TestCase):
    """ApiResponseDTOOfPagedResponseModelDTOOfJournalDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPagedResponseModelDTOOfJournalDto:
        """Test ApiResponseDTOOfPagedResponseModelDTOOfJournalDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPagedResponseModelDTOOfJournalDto`
        """
        model = ApiResponseDTOOfPagedResponseModelDTOOfJournalDto()
        if include_optional:
            return ApiResponseDTOOfPagedResponseModelDTOOfJournalDto(
                data = configuration_client.models.paged_response_model_dtoof_journal_dto.PagedResponseModelDTOOfJournalDto(
                    results = [
                        configuration_client.models.journal_dto.JournalDto(
                            description = '', 
                            code = '', 
    ...
    def testApiResponseDTOOfPagedResponseModelDTOOfJournalDto(self):
        """Test ApiResponseDTOOfPagedResponseModelDTOOfJournalDto"""
