...
class TestIScenarioDTOCorrectionNoteScenarioDTO(unittest.TestCase):
    """IScenarioDTOCorrectionNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOCorrectionNoteScenarioDTO:
        """Test IScenarioDTOCorrectionNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOCorrectionNoteScenarioDTO`
        """
        model = IScenarioDTOCorrectionNoteScenarioDTO()
        if include_optional:
            return IScenarioDTOCorrectionNoteScenarioDTO(
                type = 'CorrectionNoteScenarioDTO',
    ...
    def testIScenarioDTOCorrectionNoteScenarioDTO(self):
        """Test IScenarioDTOCorrectionNoteScenarioDTO"""
