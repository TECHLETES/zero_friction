...
class TestApiResponseDTOOfAcknowledgeMoveOutScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO:
        """Test ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO`
        """
        model = ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO(
                data = configuration_client.models.acknowledge_move_out_scenario_dto.AcknowledgeMoveOutScenarioDTO(
                    email_template = configuration_client.models.acknowledge_move_out_email_template_dto.AcknowledgeMoveOutEmailTemplateDTO(
                        subject = '', 
                        attachments = [
    ...
    def testApiResponseDTOOfAcknowledgeMoveOutScenarioDTO(self):
        """Test ApiResponseDTOOfAcknowledgeMoveOutScenarioDTO"""
