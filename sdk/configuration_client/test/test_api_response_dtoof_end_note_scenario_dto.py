...
class TestApiResponseDTOOfEndNoteScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfEndNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfEndNoteScenarioDTO:
        """Test ApiResponseDTOOfEndNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfEndNoteScenarioDTO`
        """
        model = ApiResponseDTOOfEndNoteScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfEndNoteScenarioDTO(
    ...
    def testApiResponseDTOOfEndNoteScenarioDTO(self):
        """Test ApiResponseDTOOfEndNoteScenarioDTO"""
