...
class TestIScenarioDTOCreditNoteScenarioDTO(unittest.TestCase):
    """IScenarioDTOCreditNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOCreditNoteScenarioDTO:
        """Test IScenarioDTOCreditNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOCreditNoteScenarioDTO`
        """
        model = IScenarioDTOCreditNoteScenarioDTO()
        if include_optional:
            return IScenarioDTOCreditNoteScenarioDTO(
                type = 'CreditNoteScenarioDTO',
    ...
    def testIScenarioDTOCreditNoteScenarioDTO(self):
        """Test IScenarioDTOCreditNoteScenarioDTO"""
