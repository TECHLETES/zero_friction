...
class TestApiResponseDTOOfAdvanceScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfAdvanceScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfAdvanceScenarioDTO:
        """Test ApiResponseDTOOfAdvanceScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfAdvanceScenarioDTO`
        """
        model = ApiResponseDTOOfAdvanceScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfAdvanceScenarioDTO(
                data = configuration_client.models.advance_scenario_dto.AdvanceScenarioDTO(
    ...
    def testApiResponseDTOOfAdvanceScenarioDTO(self):
        """Test ApiResponseDTOOfAdvanceScenarioDTO"""
