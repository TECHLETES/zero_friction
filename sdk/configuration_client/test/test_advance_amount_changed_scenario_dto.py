...
class TestAdvanceAmountChangedScenarioDTO(unittest.TestCase):
    """AdvanceAmountChangedScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvanceAmountChangedScenarioDTO:
        """Test AdvanceAmountChangedScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvanceAmountChangedScenarioDTO`
        """
    ...
    def testAdvanceAmountChangedScenarioDTO(self):
        """Test AdvanceAmountChangedScenarioDTO"""
