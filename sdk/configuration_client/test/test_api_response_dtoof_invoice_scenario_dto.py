...
class TestApiResponseDTOOfInvoiceScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfInvoiceScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfInvoiceScenarioDTO:
        """Test ApiResponseDTOOfInvoiceScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfInvoiceScenarioDTO`
        """
        model = ApiResponseDTOOfInvoiceScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfInvoiceScenarioDTO(
    ...
    def testApiResponseDTOOfInvoiceScenarioDTO(self):
        """Test ApiResponseDTOOfInvoiceScenarioDTO"""
