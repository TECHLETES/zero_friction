...
class TestApiResponseDTOOfReminderScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfReminderScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfReminderScenarioDTO:
        """Test ApiResponseDTOOfReminderScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfReminderScenarioDTO`
        """
        model = ApiResponseDTOOfReminderScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfReminderScenarioDTO(
                data = configuration_client.models.reminder_scenario_dto.ReminderScenarioDTO(
    ...
    def testApiResponseDTOOfReminderScenarioDTO(self):
        """Test ApiResponseDTOOfReminderScenarioDTO"""
