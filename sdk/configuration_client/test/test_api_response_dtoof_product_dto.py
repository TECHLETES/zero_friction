...
class TestApiResponseDTOOfProductDTO(unittest.TestCase):
    """ApiResponseDTOOfProductDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfProductDTO:
        """Test ApiResponseDTOOfProductDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfProductDTO`
        """
        model = ApiResponseDTOOfProductDTO()
        if include_optional:
            return ApiResponseDTOOfProductDTO(
    ...
    def testApiResponseDTOOfProductDTO(self):
        """Test ApiResponseDTOOfProductDTO"""
