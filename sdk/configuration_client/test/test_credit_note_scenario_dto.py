...
class TestCreditNoteScenarioDTO(unittest.TestCase):
    """CreditNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditNoteScenarioDTO:
        """Test CreditNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditNoteScenarioDTO`
        """
        model = CreditNoteScenarioDTO()
        if include_optional:
            return CreditNoteScenarioDTO(
    ...
    def testCreditNoteScenarioDTO(self):
        """Test CreditNoteScenarioDTO"""
