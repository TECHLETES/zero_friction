...
class TestChangeRejectMoveInScenarioRequest(unittest.TestCase):
    """ChangeRejectMoveInScenarioRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangeRejectMoveInScenarioRequest:
        """Test ChangeRejectMoveInScenarioRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeRejectMoveInScenarioRequest`
        """
    ...
    def testChangeRejectMoveInScenarioRequest(self):
        """Test ChangeRejectMoveInScenarioRequest"""
