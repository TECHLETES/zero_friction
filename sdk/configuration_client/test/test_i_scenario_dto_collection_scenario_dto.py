...
class TestIScenarioDTOCollectionScenarioDTO(unittest.TestCase):
    """IScenarioDTOCollectionScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOCollectionScenarioDTO:
        """Test IScenarioDTOCollectionScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOCollectionScenarioDTO`
        """
        model = IScenarioDTOCollectionScenarioDTO()
        if include_optional:
            return IScenarioDTOCollectionScenarioDTO(
                type = 'CollectionScenarioDTO',
    ...
    def testIScenarioDTOCollectionScenarioDTO(self):
        """Test IScenarioDTOCollectionScenarioDTO"""
