...
class TestApiResponseDTOOfCorrectionNoteScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfCorrectionNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfCorrectionNoteScenarioDTO:
        """Test ApiResponseDTOOfCorrectionNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfCorrectionNoteScenarioDTO`
        """
        model = ApiResponseDTOOfCorrectionNoteScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfCorrectionNoteScenarioDTO(
    ...
    def testApiResponseDTOOfCorrectionNoteScenarioDTO(self):
        """Test ApiResponseDTOOfCorrectionNoteScenarioDTO"""
