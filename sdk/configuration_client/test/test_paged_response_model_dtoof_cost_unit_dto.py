...
class TestPagedResponseModelDTOOfCostUnitDTO(unittest.TestCase):
    """PagedResponseModelDTOOfCostUnitDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfCostUnitDTO:
        """Test PagedResponseModelDTOOfCostUnitDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfCostUnitDTO`
        """
        model = PagedResponseModelDTOOfCostUnitDTO()
        if include_optional:
            return PagedResponseModelDTOOfCostUnitDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfCostUnitDTO(self):
        """Test PagedResponseModelDTOOfCostUnitDTO"""
