...
class TestRejectMoveOutScenarioDTO(unittest.TestCase):
    """RejectMoveOutScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RejectMoveOutScenarioDTO:
        """Test RejectMoveOutScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RejectMoveOutScenarioDTO`
        """
        model = RejectMoveOutScenarioDTO()
        if include_optional:
            return RejectMoveOutScenarioDTO(
    ...
    def testRejectMoveOutScenarioDTO(self):
        """Test RejectMoveOutScenarioDTO"""
