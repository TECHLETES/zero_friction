...
class TestIScenarioDTOOrganizationScenarioDTO(unittest.TestCase):
    """IScenarioDTOOrganizationScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOOrganizationScenarioDTO:
        """Test IScenarioDTOOrganizationScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOOrganizationScenarioDTO`
        """
        model = IScenarioDTOOrganizationScenarioDTO()
        if include_optional:
            return IScenarioDTOOrganizationScenarioDTO(
    ...
    def testIScenarioDTOOrganizationScenarioDTO(self):
        """Test IScenarioDTOOrganizationScenarioDTO"""
