...
class TestApiResponseDTOOfRejectMoveInScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfRejectMoveInScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfRejectMoveInScenarioDTO:
        """Test ApiResponseDTOOfRejectMoveInScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfRejectMoveInScenarioDTO`
        """
        model = ApiResponseDTOOfRejectMoveInScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfRejectMoveInScenarioDTO(
                data = configuration_client.models.reject_move_in_scenario_dto.RejectMoveInScenarioDTO(
    ...
    def testApiResponseDTOOfRejectMoveInScenarioDTO(self):
        """Test ApiResponseDTOOfRejectMoveInScenarioDTO"""
