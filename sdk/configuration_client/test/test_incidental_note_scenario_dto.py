...
class TestIncidentalNoteScenarioDTO(unittest.TestCase):
    """IncidentalNoteScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncidentalNoteScenarioDTO:
        """Test IncidentalNoteScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncidentalNoteScenarioDTO`
        """
        model = IncidentalNoteScenarioDTO()
        if include_optional:
            return IncidentalNoteScenarioDTO(
    ...
    def testIncidentalNoteScenarioDTO(self):
        """Test IncidentalNoteScenarioDTO"""
