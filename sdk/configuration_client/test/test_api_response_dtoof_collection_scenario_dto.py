...
class TestApiResponseDTOOfCollectionScenarioDTO(unittest.TestCase):
    """ApiResponseDTOOfCollectionScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfCollectionScenarioDTO:
        """Test ApiResponseDTOOfCollectionScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfCollectionScenarioDTO`
        """
        model = ApiResponseDTOOfCollectionScenarioDTO()
        if include_optional:
            return ApiResponseDTOOfCollectionScenarioDTO(
                data = configuration_client.models.collection_scenario_dto.CollectionScenarioDTO(
    ...
    def testApiResponseDTOOfCollectionScenarioDTO(self):
        """Test ApiResponseDTOOfCollectionScenarioDTO"""
