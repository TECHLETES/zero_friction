...
class TestIScenarioDTOAdvanceAmountChangedScenarioDTO(unittest.TestCase):
    """IScenarioDTOAdvanceAmountChangedScenarioDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IScenarioDTOAdvanceAmountChangedScenarioDTO:
        """Test IScenarioDTOAdvanceAmountChangedScenarioDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IScenarioDTOAdvanceAmountChangedScenarioDTO`
        """
        model = IScenarioDTOAdvanceAmountChangedScenarioDTO()
        if include_optional:
            return IScenarioDTOAdvanceAmountChangedScenarioDTO(
                type = 'AdvanceAmountChangedScenarioDTO',
    ...
    def testIScenarioDTOAdvanceAmountChangedScenarioDTO(self):
        """Test IScenarioDTOAdvanceAmountChangedScenarioDTO"""
