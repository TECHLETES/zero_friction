...
class TestBasePdfTemplateDTO(unittest.TestCase):
    """BasePdfTemplateDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasePdfTemplateDTO:
        """Test BasePdfTemplateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasePdfTemplateDTO`
        """
    ...
    def testBasePdfTemplateDTO(self):
        """Test BasePdfTemplateDTO"""
