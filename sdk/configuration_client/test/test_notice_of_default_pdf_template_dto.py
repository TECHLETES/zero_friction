...
class TestNoticeOfDefaultPdfTemplateDTO(unittest.TestCase):
    """NoticeOfDefaultPdfTemplateDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoticeOfDefaultPdfTemplateDTO:
        """Test NoticeOfDefaultPdfTemplateDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoticeOfDefaultPdfTemplateDTO`
        """
        model = NoticeOfDefaultPdfTemplateDTO()
        if include_optional:
            return NoticeOfDefaultPdfTemplateDTO(
                file_name = '',
                use_case = 'pdf',
                use_build_in = True,
    ...
    def testNoticeOfDefaultPdfTemplateDTO(self):
        """Test NoticeOfDefaultPdfTemplateDTO"""
