...
class BasePdfTemplateDTOAnnualStatementPdfTemplateDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["$type", "showCountry", "showBalance", "showVatSpecs", "showCustomInformation", "envelopeSettings", "renderHeaderFooter", "headerText", "footerText", "overrideExternalPrintingChecks", "supportsExternalPrinting", "fileName", "useCase", "useBuildIn", "customTemplateInternalFilePath", "customTemplateFileName", "translationStatus"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AnnualStatementPdfTemplateDTO']):
            raise ValueError("must be one of enum values ('AnnualStatementPdfTemplateDTO')")
        return value
