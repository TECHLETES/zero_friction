...
class MasterDataParametersDTO(BaseModel):
    """
    MasterDataParametersDTO
    """ # noqa: E501
    excluded_utility_types: Optional[List[UtilityType]] = Field(default=None, alias="excludedUtilityTypes")
    ...
    __properties: ClassVar[List[str]] = ["excludedUtilityTypes", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "excludedUtilityTypes": obj.get("excludedUtilityTypes"),
