...
class BaseEmailTemplateRequestUpdateAnnualStatementEmailTemplateRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdateAnnualStatementEmailTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdateAnnualStatementEmailTemplateRequest')")
        return value
