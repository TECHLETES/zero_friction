...
class BaseEmailTemplateRequestUpdatePortalPersonalInformationChangedEmailTemplateRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdatePortalPersonalInformationChangedEmailTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdatePortalPersonalInformationChangedEmailTemplateRequest')")
        return value
