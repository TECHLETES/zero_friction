...
class IScenarioDTOContractWelcomeScenarioDTO(BaseModel):
    """
    IScenarioDTOContractWelcomeScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[ContractWelcomeEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ContractWelcomeScenarioDTO']):
            raise ValueError("must be one of enum values ('ContractWelcomeScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": ContractWelcomeEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
