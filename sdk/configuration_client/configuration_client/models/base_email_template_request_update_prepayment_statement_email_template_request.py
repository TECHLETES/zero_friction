...
class BaseEmailTemplateRequestUpdatePrepaymentStatementEmailTemplateRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdatePrepaymentStatementEmailTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdatePrepaymentStatementEmailTemplateRequest')")
        return value
