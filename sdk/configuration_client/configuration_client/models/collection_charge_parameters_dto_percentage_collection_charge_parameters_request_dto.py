...
class CollectionChargeParametersDTOPercentageCollectionChargeParametersRequestDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "percentage", "taxCodeId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PercentageCollectionChargeParametersRequestDTO']):
            raise ValueError("must be one of enum values ('PercentageCollectionChargeParametersRequestDTO')")
        return value
