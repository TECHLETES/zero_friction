...
class ChangePaymentPlanActivatedScenarioRequest(BaseModel):
    """
    ChangePaymentPlanActivatedScenarioRequest
    """ # noqa: E501
    pdf_template: Optional[PaymentPlanActivatedPdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[PaymentPlanActivatedEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pdfTemplate": PaymentPlanActivatedPdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": PaymentPlanActivatedEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
