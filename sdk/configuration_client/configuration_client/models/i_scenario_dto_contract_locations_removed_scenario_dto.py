...
class IScenarioDTOContractLocationsRemovedScenarioDTO(BaseModel):
    """
    IScenarioDTOContractLocationsRemovedScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[ContractLocationsRemovedEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    __properties: ClassVar[List[str]] = ["$type", "emailTemplate", "defaultCommunicationType", "autoFallbackToPostal", "translationListId", "translationListHistoryId", "dataType", "entitySubjectType", "entitySubjectSubType", "groupingType", "entityType", "availableCommunicationTypes"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ContractLocationsRemovedScenarioDTO']):
            raise ValueError("must be one of enum values ('ContractLocationsRemovedScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": ContractLocationsRemovedEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
