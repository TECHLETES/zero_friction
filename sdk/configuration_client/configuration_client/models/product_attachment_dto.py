...
class ProductAttachmentDTO(BaseModel):
    """
    ...
    attachment_files: Optional[List[ProductAttachmentFileDTO]] = Field(default=None, alias="attachmentFiles")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachmentFiles": [ProductAttachmentFileDTO.from_dict(_item) for _item in obj["attachmentFiles"]] if obj.get("attachmentFiles") is not None else None
        })
        return _obj
