...
class UpdateEntityTranslationRequest(BaseModel):
    """
    UpdateEntityTranslationRequest
    """ # noqa: E501
    translated_fields: Dict[str, Dict[str, StrictStr]] = Field(alias="translatedFields")
    __properties: ClassVar[List[str]] = ["translatedFields"]
