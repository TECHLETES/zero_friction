...
class IScenarioDTOContractTerminationScenarioDTO(BaseModel):
    """
    IScenarioDTOContractTerminationScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[ContractTerminationEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['ContractTerminationScenarioDTO']):
            raise ValueError("must be one of enum values ('ContractTerminationScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": ContractTerminationEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
