...
class ChangeCreditNoteScenarioRequest(BaseModel):
    ...
    """ # noqa: E501
    pdf_template: Optional[CreditNotePdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[CreditNoteEmailTemplateRequest] = Field(alias="emailTemplate")
