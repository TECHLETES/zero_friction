...
class ChangeIncidentalNoteScenarioRequest(BaseModel):
    """
    ...
    pdf_template: Optional[IncidentalNotePdfTemplateRequest] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[IncidentalNoteEmailTemplateRequest] = Field(default=None, alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pdfTemplate": IncidentalNotePdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": IncidentalNoteEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None
        })
        return _obj
