...
class ChangeIncidentalNoteScenarioRequest(BaseModel):
    ...
    """ # noqa: E501
    pdf_template: Optional[IncidentalNotePdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[IncidentalNoteEmailTemplateRequest] = Field(alias="emailTemplate")
