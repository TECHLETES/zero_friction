...
class DataExportDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "parameters", "fileFormatId", "deleted", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
