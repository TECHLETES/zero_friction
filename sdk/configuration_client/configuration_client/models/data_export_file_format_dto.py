...
class DataExportFileFormatDTO(BaseModel):
    """
    ...
    settings: Optional[BaseDataExportSettingsDTOInvoiceExportSettingsDTO] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "deleted", "settings", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
