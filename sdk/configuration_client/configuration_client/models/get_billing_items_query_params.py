...
class GetBillingItemsQueryParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["showDeleted", "name", "calculationType", "utilityType", "productId", "isPrepaymentEligible", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_prepayment_eligible (nullable) is None
        # and model_fields_set contains the field
        if self.is_prepayment_eligible is None and "is_prepayment_eligible" in self.model_fields_set:
            _dict['isPrepaymentEligible'] = None
