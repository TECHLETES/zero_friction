...
class ChangePaymentPlanReminderScenarioRequest(BaseModel):
    """
    ChangePaymentPlanReminderScenarioRequest
    """ # noqa: E501
    pdf_template: Optional[PaymentPlanReminderPdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[PaymentPlanReminderEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pdfTemplate": PaymentPlanReminderPdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": PaymentPlanReminderEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
