...
class TimeOfUseCalendarDTO(BaseModel):
    """
    TimeOfUseCalendarDTO
    """ # noqa: E501
    code: Optional[StrictStr] = None
    weekdays: Optional[List[TimeOfUseDayDTO]] = None
    ...
    __properties: ClassVar[List[str]] = ["code", "weekdays", "deleted", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
