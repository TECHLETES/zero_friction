...
class BaseTariffCalculationTypeParametersDTOStairStepTariffCalculationTypeParametersDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['stairstep']):
            raise ValueError("must be one of enum values ('stairstep')")
        return value
