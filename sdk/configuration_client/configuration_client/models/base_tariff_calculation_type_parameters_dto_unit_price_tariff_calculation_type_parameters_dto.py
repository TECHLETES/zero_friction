...
class BaseTariffCalculationTypeParametersDTOUnitPriceTariffCalculationTypeParametersDTO(BaseModel):
    """
    BaseTariffCalculationTypeParametersDTOUnitPriceTariffCalculationTypeParametersDTO
    """ # noqa: E501
    type: Optional[StrictStr] = None
    formula_based: Optional[StrictBool] = Field(default=None, alias="formulaBased")
    input_parameters: Optional[List[BillingTariffInputDTO]] = Field(default=None, alias="inputParameters")
    unit_tariff: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="unitTariff")
    ...
    __properties: ClassVar[List[str]] = ["type", "formulaBased", "inputParameters", "unitTariff", "expression", "calculationType"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['unitprice']):
            raise ValueError("must be one of enum values ('unitprice')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "formulaBased": obj.get("formulaBased"),
            "inputParameters": [BillingTariffInputDTO.from_dict(_item) for _item in obj["inputParameters"]] if obj.get("inputParameters") is not None else None,
            "unitTariff": obj.get("unitTariff"),
