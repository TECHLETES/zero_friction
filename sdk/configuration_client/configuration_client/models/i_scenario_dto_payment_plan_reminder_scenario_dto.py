...
class IScenarioDTOPaymentPlanReminderScenarioDTO(BaseModel):
    """
    IScenarioDTOPaymentPlanReminderScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[PaymentPlanReminderEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    pdf_template: Optional[PaymentPlanReminderPdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PaymentPlanReminderScenarioDTO']):
            raise ValueError("must be one of enum values ('PaymentPlanReminderScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": PaymentPlanReminderEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
            "pdfTemplate": PaymentPlanReminderPdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
