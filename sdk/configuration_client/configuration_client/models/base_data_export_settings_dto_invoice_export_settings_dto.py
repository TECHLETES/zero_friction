...
class BaseDataExportSettingsDTOInvoiceExportSettingsDTO(BaseModel):
    """
    BaseDataExportSettingsDTOInvoiceExportSettingsDTO
    """ # noqa: E501
    type: Optional[StrictStr] = None
    format: Optional[BaseInvoiceExportFormatDTO]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "format": BaseInvoiceExportFormatDTO.from_dict(obj["format"]) if obj.get("format") is not None else None
        })
        return _obj
