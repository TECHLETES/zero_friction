...
class ChangeCorrectionNoteScenarioRequest(BaseModel):
    ...
    """ # noqa: E501
    pdf_template: Optional[CorrectionNotePdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[CorrectionNoteEmailTemplateRequest] = Field(alias="emailTemplate")
