...
class ChangeCorrectionNoteScenarioRequest(BaseModel):
    """
    ...
    pdf_template: Optional[CorrectionNotePdfTemplateRequest] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[CorrectionNoteEmailTemplateRequest] = Field(default=None, alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pdfTemplate": CorrectionNotePdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": CorrectionNoteEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None
        })
        return _obj
