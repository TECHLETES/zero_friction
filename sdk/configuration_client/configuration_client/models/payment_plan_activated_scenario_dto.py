...
class PaymentPlanActivatedScenarioDTO(BaseModel):
    """
    PaymentPlanActivatedScenarioDTO
    """ # noqa: E501
    email_template: Optional[PaymentPlanActivatedEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    pdf_template: Optional[PaymentPlanActivatedPdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailTemplate": PaymentPlanActivatedEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
            "pdfTemplate": PaymentPlanActivatedPdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
