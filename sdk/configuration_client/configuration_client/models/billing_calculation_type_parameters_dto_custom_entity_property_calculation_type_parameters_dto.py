...
class BillingCalculationTypeParametersDTOCustomEntityPropertyCalculationTypeParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "customEntityPropertyTypeId", "scope", "utilityType", "billingCalculationType", "unitOfMeasure"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['customentityproperty']):
            raise ValueError("must be one of enum values ('customentityproperty')")
        return value
