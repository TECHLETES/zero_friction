...
class BaseEmailTemplateDTOPortalEmailChangedEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PortalEmailChangedEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PortalEmailChangedEmailTemplateDTO')")
        return value
