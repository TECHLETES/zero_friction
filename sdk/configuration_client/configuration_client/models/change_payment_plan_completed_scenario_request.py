...
class ChangePaymentPlanCompletedScenarioRequest(BaseModel):
    """
    ChangePaymentPlanCompletedScenarioRequest
    """ # noqa: E501
    pdf_template: Optional[PaymentPlanCompletedPdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[PaymentPlanCompletedEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pdfTemplate": PaymentPlanCompletedPdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": PaymentPlanCompletedEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
