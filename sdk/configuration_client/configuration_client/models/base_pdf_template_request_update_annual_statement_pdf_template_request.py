...
class BasePdfTemplateRequestUpdateAnnualStatementPdfTemplateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "showCountry", "showBalance", "showVatSpecs", "showCustomInformation", "envelopeSettings"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdateAnnualStatementPdfTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdateAnnualStatementPdfTemplateRequest')")
        return value
