...
class ChangeEndNoteScenarioRequest(BaseModel):
    """
    ...
    pdf_template: Optional[EndNotePdfTemplateRequest] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[EndNoteEmailTemplateRequest] = Field(default=None, alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pdfTemplate": EndNotePdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": EndNoteEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None
        })
        return _obj
