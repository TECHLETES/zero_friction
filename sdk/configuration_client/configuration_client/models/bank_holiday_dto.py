...
class BankHolidayDTO(BaseModel):
    """
    BankHolidayDTO
    """ # noqa: E501
    ...
    types: Optional[List[BankHolidayType]] = None
    counties: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["name", "title", "date", "productionDay", "isActive", "types", "counties"]
