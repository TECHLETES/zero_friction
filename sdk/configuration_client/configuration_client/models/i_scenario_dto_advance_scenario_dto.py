...
class IScenarioDTOAdvanceScenarioDTO(BaseModel):
    """
    IScenarioDTOAdvanceScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    pdf_template: Optional[AdvancePdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[AdvanceEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['AdvanceScenarioDTO']):
            raise ValueError("must be one of enum values ('AdvanceScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "pdfTemplate": AdvancePdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": AdvanceEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
