...
class IScenarioDTOAdvanceAmountChangedScenarioDTO(BaseModel):
    """
    IScenarioDTOAdvanceAmountChangedScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[AdvanceAmountChangedEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['AdvanceAmountChangedScenarioDTO']):
            raise ValueError("must be one of enum values ('AdvanceAmountChangedScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": AdvanceAmountChangedEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
