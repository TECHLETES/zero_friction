...
class DataImportFileFormatDTO(BaseModel):
    ...
    settings: Optional[BaseDataImportSettingsDTO] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "deleted", "isBuiltIn", "settings", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
