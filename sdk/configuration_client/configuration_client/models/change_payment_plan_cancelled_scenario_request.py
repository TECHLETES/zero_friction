...
class ChangePaymentPlanCancelledScenarioRequest(BaseModel):
    """
    ChangePaymentPlanCancelledScenarioRequest
    """ # noqa: E501
    pdf_template: Optional[PaymentPlanCancelledPdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[PaymentPlanCancelledEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pdfTemplate": PaymentPlanCancelledPdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": PaymentPlanCancelledEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
