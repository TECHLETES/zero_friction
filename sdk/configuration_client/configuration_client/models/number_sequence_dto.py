...
class NumberSequenceDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["referenceEntity", "lastValue", "segments", "formatString", "gaps", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
