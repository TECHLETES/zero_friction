...
class CreateCostCenterRequest(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The code of the cost center.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the cost center itself.  Currently, we only support the description in one language so this field is not localized.")
