...
class CostComponentValueDTO(BaseModel):
    """
    ...
    cost_component_id: Optional[StrictStr] = Field(default=None, alias="costComponentId")
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "costComponentId", "value", "startDateTime", "endDateTime", "deleted"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if cost_component_id (nullable) is None
        # and model_fields_set contains the field
        if self.cost_component_id is None and "cost_component_id" in self.model_fields_set:
            _dict['costComponentId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "costComponentId": obj.get("costComponentId"),
            "value": obj.get("value"),
