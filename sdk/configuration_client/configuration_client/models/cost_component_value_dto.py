...
class CostComponentValueDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["costComponentId", "value", "startDateTime", "endDateTime", "deleted", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
