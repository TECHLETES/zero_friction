...
class CostComponentDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "deleted", "localisationLevel", "localisedFields", "translatedFields", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
