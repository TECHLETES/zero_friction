...
class CostComponentDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "name", "description", "deleted", "localisationLevel", "localisedFields", "translatedFields"]
