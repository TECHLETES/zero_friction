...
class IScenarioDTOEndNoteScenarioDTO(BaseModel):
    """
    IScenarioDTOEndNoteScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    pdf_template: Optional[EndNotePdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[EndNoteEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['EndNoteScenarioDTO']):
            raise ValueError("must be one of enum values ('EndNoteScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "pdfTemplate": EndNotePdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": EndNoteEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
