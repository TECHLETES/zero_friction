...
class ChangePaymentPlanRequestedScenarioRequest(BaseModel):
    """
    ChangePaymentPlanRequestedScenarioRequest
    """ # noqa: E501
    pdf_template: Optional[PaymentPlanRequestedPdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[PaymentPlanRequestedEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pdfTemplate": PaymentPlanRequestedPdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": PaymentPlanRequestedEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
