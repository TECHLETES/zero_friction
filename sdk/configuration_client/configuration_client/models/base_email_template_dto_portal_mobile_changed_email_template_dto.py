...
class BaseEmailTemplateDTOPortalMobileChangedEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PortalMobileChangedEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PortalMobileChangedEmailTemplateDTO')")
        return value
