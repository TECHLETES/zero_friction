...
class DataImportParametersDTOFTPSDataImportParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "host", "port", "userName", "password", "protocol", "directory", "recurrence", "nextRunDateTime"]
