...
class ChangePaymentPlanRecalculatedScenarioRequest(BaseModel):
    """
    ChangePaymentPlanRecalculatedScenarioRequest
    """ # noqa: E501
    pdf_template: Optional[PaymentPlanRecalculatedPdfTemplateRequest] = Field(alias="pdfTemplate")
    email_template: Optional[PaymentPlanRecalculatedEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pdfTemplate": PaymentPlanRecalculatedPdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": PaymentPlanRecalculatedEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
