...
class TimeOfUseTypeDTO(BaseModel):
    """
    TimeOfUseTypeDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["code", "description", "deleted", "localisationLevel", "localisedFields", "translatedFields", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
