...
class BillingCalculationTypeParametersDTOAttributeCalculationTypeParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "billingCalculationType", "unitOfMeasure"]
