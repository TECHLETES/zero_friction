...
class CreditNotePdfTemplateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["showCountry", "showBalance", "showVatSpecs", "showCustomInformation", "envelopeSettings"]
