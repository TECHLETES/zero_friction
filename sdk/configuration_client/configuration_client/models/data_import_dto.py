...
class DataImportDTO(BaseModel):
    ...
    metering_format_type: Optional[DataImportMeteringFormatType] = Field(default=None, alias="meteringFormatType")
    parameters: Optional[DataImportParametersDTO] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "customFileFormatId", "meteringFormatType", "parameters", "automaticProcessing", "disabled", "deleted", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
