...
class BaseDataImportSettingsDTOMigrationSettingsDTO(BaseModel):
    """
    BaseDataImportSettingsDTOMigrationSettingsDTO
    """ # noqa: E501
    type: Optional[StrictStr] = None
    format: BaseMigrationFormatDTOZFBulkImportFormatDTO
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['migration']):
            raise ValueError("must be one of enum values ('migration')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "format": BaseMigrationFormatDTOZFBulkImportFormatDTO.from_dict(obj["format"]) if obj.get("format") is not None else None
        })
        return _obj
