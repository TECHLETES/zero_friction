...
class BillingCalculationTypeParametersDTOSubscriptionCalculationTypeParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "utilityType", "scope", "billingCalculationType", "unitOfMeasure"]
