...
class IScenarioDTONoticeOfDefaultScenarioDTO(BaseModel):
    """
    IScenarioDTONoticeOfDefaultScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    pdf_template: Optional[NoticeOfDefaultPdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[NoticeOfDefaultEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    ...
    __properties: ClassVar[List[str]] = ["$type", "pdfTemplate", "emailTemplate", "defaultCommunicationType", "autoFallbackToPostal", "translationListId", "translationListHistoryId", "dataType", "entitySubjectType", "entitySubjectSubType", "groupingType", "entityType", "availableCommunicationTypes"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['NoticeOfDefaultScenarioDTO']):
            raise ValueError("must be one of enum values ('NoticeOfDefaultScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "pdfTemplate": NoticeOfDefaultPdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": NoticeOfDefaultEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
