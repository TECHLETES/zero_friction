...
class BaseEmailTemplateDTOPortalPersonalInformationChangedEmailTemplateDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["$type", "subject", "attachments", "fileName", "useCase", "useBuildIn", "customTemplateInternalFilePath", "customTemplateFileName", "translationStatus"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PortalPersonalInformationChangedEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PortalPersonalInformationChangedEmailTemplateDTO')")
        return value
