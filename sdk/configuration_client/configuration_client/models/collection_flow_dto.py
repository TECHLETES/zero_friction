...
class CollectionFlowDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "name", "daysAfterInvoiceDue", "stepIds", "deleted"]
