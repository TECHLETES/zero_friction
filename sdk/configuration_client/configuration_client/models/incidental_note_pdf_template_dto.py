...
class IncidentalNotePdfTemplateDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fileName", "useCase", "useBuildIn", "customTemplateInternalFilePath", "customTemplateFileName", "translationStatus", "envelopeSettings", "renderHeaderFooter", "headerText", "footerText", "overrideExternalPrintingChecks", "supportsExternalPrinting", "showCountry", "showBalance", "showVatSpecs", "showCustomInformation"]
