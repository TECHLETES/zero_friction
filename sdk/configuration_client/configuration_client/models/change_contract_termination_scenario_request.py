...
class ChangeContractTerminationScenarioRequest(BaseModel):
    """
    ChangeContractTerminationScenarioRequest
    """ # noqa: E501
    email_template: Optional[ContractTerminationEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailTemplate": ContractTerminationEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
