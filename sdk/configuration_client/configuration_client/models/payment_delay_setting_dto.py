...
class PaymentDelaySettingDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "invoiceType", "paymentDelay", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentDelay": obj.get("paymentDelay"),
            "value": obj.get("value")
        })
        return _obj
