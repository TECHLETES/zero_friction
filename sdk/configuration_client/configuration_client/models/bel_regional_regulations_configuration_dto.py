...
class BELRegionalRegulationsConfigurationDTO(BaseModel):
    """
    ...
    social_tariff_parameters: Optional[SocialTariffParametersDTO] = Field(default=None, alias="socialTariffParameters")
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "countryCode", "socialTariffParameters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of social_tariff_parameters
        if self.social_tariff_parameters:
            _dict['socialTariffParameters'] = self.social_tariff_parameters.to_dict()
        ...
        # set to None if social_tariff_parameters (nullable) is None
        # and model_fields_set contains the field
        if self.social_tariff_parameters is None and "social_tariff_parameters" in self.model_fields_set:
            _dict['socialTariffParameters'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "socialTariffParameters": SocialTariffParametersDTO.from_dict(obj["socialTariffParameters"]) if obj.get("socialTariffParameters") is not None else None
        })
        return _obj
