...
class BaseEmailTemplateRequestUpdatePortalCustomerResetAccountEmailTemplateRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdatePortalCustomerResetAccountEmailTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdatePortalCustomerResetAccountEmailTemplateRequest')")
        return value
