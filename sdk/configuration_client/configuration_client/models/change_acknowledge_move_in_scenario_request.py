...
class ChangeAcknowledgeMoveInScenarioRequest(BaseModel):
    """
    ChangeAcknowledgeMoveInScenarioRequest
    """ # noqa: E501
    email_template: Optional[AcknowledgeMoveInEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailTemplate": AcknowledgeMoveInEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
