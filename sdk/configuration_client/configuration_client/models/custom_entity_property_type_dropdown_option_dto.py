...
class CustomEntityPropertyTypeDropdownOptionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "option", "deleted"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if option (nullable) is None
        # and model_fields_set contains the field
        if self.option is None and "option" in self.model_fields_set:
            _dict['option'] = None
