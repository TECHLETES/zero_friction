...
class ChangeAcknowledgeMoveOutScenarioRequest(BaseModel):
    """
    ChangeAcknowledgeMoveOutScenarioRequest
    """ # noqa: E501
    email_template: Optional[AcknowledgeMoveOutEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailTemplate": AcknowledgeMoveOutEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
