...
class PortalAdvanceChangeLimitRequest(BaseModel):
    """
    PortalAdvanceChangeLimitRequest
    """ # noqa: E501
    range_min: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="rangeMin")
    range_max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="rangeMax")
    type: Optional[AdvanceAmountLimitType] = None
    __properties: ClassVar[List[str]] = ["rangeMin", "rangeMax", "type"]
