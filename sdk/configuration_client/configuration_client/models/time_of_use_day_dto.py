...
class TimeOfUseDayDTO(BaseModel):
    """
    TimeOfUseDayDTO
    """ # noqa: E501
    weekday_index: Optional[StrictInt] = Field(default=None, alias="weekdayIndex")
    intervals: Optional[List[TimeOfUseIntervalDTO]] = None
    __properties: ClassVar[List[str]] = ["weekdayIndex", "intervals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "weekdayIndex": obj.get("weekdayIndex"),
            "intervals": [TimeOfUseIntervalDTO.from_dict(_item) for _item in obj["intervals"]] if obj.get("intervals") is not None else None
        })
        return _obj
