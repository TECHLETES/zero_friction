...
class ChangeContractLocationsRemovedScenarioRequest(BaseModel):
    ...
    email_template: Optional[ContractLocationsRemovedEmailTemplateRequest] = Field(default=None, alias="emailTemplate")
    __properties: ClassVar[List[str]] = ["defaultCommunicationType", "emailTemplate"]
