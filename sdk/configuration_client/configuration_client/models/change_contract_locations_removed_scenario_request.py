...
class ChangeContractLocationsRemovedScenarioRequest(BaseModel):
    """
    ChangeContractLocationsRemovedScenarioRequest
    """ # noqa: E501
    email_template: Optional[ContractLocationsRemovedEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    __properties: ClassVar[List[str]] = ["emailTemplate", "defaultCommunicationType", "autoFallbackToPostal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailTemplate": ContractLocationsRemovedEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
