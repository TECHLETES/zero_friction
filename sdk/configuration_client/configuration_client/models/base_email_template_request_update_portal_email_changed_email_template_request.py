...
class BaseEmailTemplateRequestUpdatePortalEmailChangedEmailTemplateRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdatePortalEmailChangedEmailTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdatePortalEmailChangedEmailTemplateRequest')")
        return value
