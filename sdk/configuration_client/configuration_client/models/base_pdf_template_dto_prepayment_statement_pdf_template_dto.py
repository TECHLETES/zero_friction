...
class BasePdfTemplateDTOPrepaymentStatementPdfTemplateDTO(BaseModel):
    """
    ...
    is_closing_statement: Optional[StrictBool] = Field(default=None, alias="isClosingStatement")
    ...
    __properties: ClassVar[List[str]] = ["$type", "showCountry", "showVatSpecs", "showCustomInformation", "isClosingStatement", "envelopeSettings", "renderHeaderFooter", "headerText", "footerText", "overrideExternalPrintingChecks", "supportsExternalPrinting", "fileName", "useCase", "useBuildIn", "customTemplateInternalFilePath", "customTemplateFileName", "translationStatus"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PrepaymentStatementPdfTemplateDTO']):
            raise ValueError("must be one of enum values ('PrepaymentStatementPdfTemplateDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isClosingStatement": obj.get("isClosingStatement"),
