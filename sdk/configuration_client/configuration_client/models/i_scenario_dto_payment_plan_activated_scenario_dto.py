...
class IScenarioDTOPaymentPlanActivatedScenarioDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PaymentPlanActivatedScenarioDTO']):
            raise ValueError("must be one of enum values ('PaymentPlanActivatedScenarioDTO')")
        return value
