...
class BasePdfTemplateRequestUpdatePrepaymentStatementPdfTemplateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "showCountry", "showVatSpecs", "showCustomInformation", "isClosingStatement", "envelopeSettings"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdatePrepaymentStatementPdfTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdatePrepaymentStatementPdfTemplateRequest')")
        return value
