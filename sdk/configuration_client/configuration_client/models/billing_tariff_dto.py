...
class BillingTariffDTO(BaseModel):
    ...
    condition_parameters: Optional[List[Dict[str, Any]]] = Field(default=None, alias="conditionParameters")
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "productId", "billingItemId", "contractId", "calculationParameters", "conditionParameters", "startDateTime", "endDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditionParameters": obj.get("conditionParameters"),
