...
class IScenarioDTOPaymentPlanCreatedScenarioDTO(BaseModel):
    """
    IScenarioDTOPaymentPlanCreatedScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[PaymentPlanCreatedEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    pdf_template: Optional[PaymentPlanCreatedPdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PaymentPlanCreatedScenarioDTO']):
            raise ValueError("must be one of enum values ('PaymentPlanCreatedScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": PaymentPlanCreatedEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
            "pdfTemplate": PaymentPlanCreatedPdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
