...
class BaseEmailTemplateDTOPortalResetPasswordEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PortalResetPasswordEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PortalResetPasswordEmailTemplateDTO')")
        return value
