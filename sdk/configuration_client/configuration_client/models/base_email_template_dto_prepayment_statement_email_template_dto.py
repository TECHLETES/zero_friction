...
class BaseEmailTemplateDTOPrepaymentStatementEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PrepaymentStatementEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PrepaymentStatementEmailTemplateDTO')")
        return value
