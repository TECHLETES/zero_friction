...
class BaseEmailTemplateDTOPortalConfirmationEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PortalConfirmationEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PortalConfirmationEmailTemplateDTO')")
        return value
