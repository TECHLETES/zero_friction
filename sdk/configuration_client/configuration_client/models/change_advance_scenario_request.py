...
class ChangeAdvanceScenarioRequest(BaseModel):
    """
    ...
    pdf_template: Optional[AdvancePdfTemplateRequest] = Field(default=None, alias="pdfTemplate")
    email_template: Optional[AdvanceEmailTemplateRequest] = Field(default=None, alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pdfTemplate": AdvancePdfTemplateRequest.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
            "emailTemplate": AdvanceEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None
        })
        return _obj
