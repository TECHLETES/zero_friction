...
class ChangeContractWelcomeScenarioRequest(BaseModel):
    """
    ChangeContractWelcomeScenarioRequest
    """ # noqa: E501
    email_template: Optional[ContractWelcomeEmailTemplateRequest] = Field(alias="emailTemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emailTemplate": ContractWelcomeEmailTemplateRequest.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
