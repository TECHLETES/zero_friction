...
class ConsumptionUnitTypeDTO(BaseModel):
    """
    ...
    allowed_entity_subject_types: Optional[List[EntitySubjectType]] = Field(default=None, alias="allowedEntitySubjectTypes")
    ...
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "name", "description", "allowedEntitySubjectTypes", "deleted", "localisationLevel", "localisedFields", "translatedFields"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if allowed_entity_subject_types (nullable) is None
        # and model_fields_set contains the field
        if self.allowed_entity_subject_types is None and "allowed_entity_subject_types" in self.model_fields_set:
            _dict['allowedEntitySubjectTypes'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowedEntitySubjectTypes": obj.get("allowedEntitySubjectTypes"),
