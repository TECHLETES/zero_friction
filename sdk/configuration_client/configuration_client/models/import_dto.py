...
class ImportDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["importType", "status", "locked", "canBeUndone", "filePath", "originalFileName", "finishedOn", "importLineErrors", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
