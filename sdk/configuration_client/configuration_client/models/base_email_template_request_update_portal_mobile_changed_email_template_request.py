...
class BaseEmailTemplateRequestUpdatePortalMobileChangedEmailTemplateRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['UpdatePortalMobileChangedEmailTemplateRequest']):
            raise ValueError("must be one of enum values ('UpdatePortalMobileChangedEmailTemplateRequest')")
        return value
