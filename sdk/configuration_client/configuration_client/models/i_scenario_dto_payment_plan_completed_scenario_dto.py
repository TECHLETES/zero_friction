...
class IScenarioDTOPaymentPlanCompletedScenarioDTO(BaseModel):
    """
    IScenarioDTOPaymentPlanCompletedScenarioDTO
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, alias="$type")
    email_template: Optional[PaymentPlanCompletedEmailTemplateDTO] = Field(default=None, alias="emailTemplate")
    pdf_template: Optional[PaymentPlanCompletedPdfTemplateDTO] = Field(default=None, alias="pdfTemplate")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PaymentPlanCompletedScenarioDTO']):
            raise ValueError("must be one of enum values ('PaymentPlanCompletedScenarioDTO')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "$type": obj.get("$type"),
            "emailTemplate": PaymentPlanCompletedEmailTemplateDTO.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
            "pdfTemplate": PaymentPlanCompletedPdfTemplateDTO.from_dict(obj["pdfTemplate"]) if obj.get("pdfTemplate") is not None else None,
