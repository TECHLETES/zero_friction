...
class CostComponentValueRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["existingId", "startDateTime", "endDateTime", "value", "dateRange"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if existing_id (nullable) is None
        # and model_fields_set contains the field
        if self.existing_id is None and "existing_id" in self.model_fields_set:
            _dict['existingId'] = None
