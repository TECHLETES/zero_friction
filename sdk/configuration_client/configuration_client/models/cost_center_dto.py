...
class CostCenterDTO(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="The description of the cost center.")
    code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The code of the cost center.")
    external_accounting_metadata: ExternalAccountingMetadataDTO = Field(description="Metadata about the external accounting system from which this cost center was retrieved.", alias="externalAccountingMetadata")
