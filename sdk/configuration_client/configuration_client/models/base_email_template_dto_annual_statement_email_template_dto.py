...
class BaseEmailTemplateDTOAnnualStatementEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AnnualStatementEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('AnnualStatementEmailTemplateDTO')")
        return value
