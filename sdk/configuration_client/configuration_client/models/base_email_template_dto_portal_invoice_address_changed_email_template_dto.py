...
class BaseEmailTemplateDTOPortalInvoiceAddressChangedEmailTemplateDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PortalInvoiceAddressChangedEmailTemplateDTO']):
            raise ValueError("must be one of enum values ('PortalInvoiceAddressChangedEmailTemplateDTO')")
        return value
