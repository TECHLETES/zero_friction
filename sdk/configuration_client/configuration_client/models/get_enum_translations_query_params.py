...
class GetEnumTranslationsQueryParams(BaseModel):
    """
    GetEnumTranslationsQueryParams
    """ # noqa: E501
    enum_type: Optional[StrictStr] = Field(default=None, alias="enumType")
    translation_status: Optional[List[StrictStr]] = Field(default=None, alias="translationStatus")
    ...
    __properties: ClassVar[List[str]] = ["enumType", "translationStatus", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if enum_type (nullable) is None
        # and model_fields_set contains the field
        if self.enum_type is None and "enum_type" in self.model_fields_set:
            _dict['enumType'] = None
