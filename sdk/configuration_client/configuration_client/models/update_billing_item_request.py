...
class UpdateBillingItemRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "personTaxCodeId", "organisationTaxCodeId", "accountingCodeId", "hideWhenZero", "isPrepaymentEligible", "tierCalculationMethod", "calculationParameters"]
