...
class GeneralLedgerCodeDTO(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="The description of the general ledger code.")
    code: Optional[StrictStr] = Field(default=None, description="The code of the general ledger.")
    external_accounting_metadata: ExternalAccountingMetadataDTO = Field(description="Metadata about the external accounting system from which this general ledger code was retrieved.", alias="externalAccountingMetadata")
