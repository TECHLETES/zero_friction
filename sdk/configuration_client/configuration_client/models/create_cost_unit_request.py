...
class CreateCostUnitRequest(BaseModel):
    """
    Request model for creating a new cost unit.
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The code of the cost unit.")
    description: Optional[StrictStr] = Field(default=None, description="Description of the cost unit itself.  Currently, we only support the description in one language so this field is not localized.")
