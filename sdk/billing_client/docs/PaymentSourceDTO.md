...
json = "{}"
# create an instance of PaymentSourceDTO from a JSON string
payment_source_dto_instance = PaymentSourceDTO.from_json(json)
# print the JSON string representation of the object
print(PaymentSourceDTO.to_json())

# convert the object into a dict
payment_source_dto_dict = payment_source_dto_instance.to_dict()
# create an instance of PaymentSourceDTO from a dict
payment_source_dto_from_dict = PaymentSourceDTO.from_dict(payment_source_dto_dict)
```
