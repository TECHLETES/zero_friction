...
json = "{}"
# create an instance of OutgoingMutationReferenceParametersDTO from a JSON string
outgoing_mutation_reference_parameters_dto_instance = OutgoingMutationReferenceParametersDTO.from_json(json)
# print the JSON string representation of the object
print(OutgoingMutationReferenceParametersDTO.to_json())

# convert the object into a dict
outgoing_mutation_reference_parameters_dto_dict = outgoing_mutation_reference_parameters_dto_instance.to_dict()
# create an instance of OutgoingMutationReferenceParametersDTO from a dict
outgoing_mutation_reference_parameters_dto_from_dict = OutgoingMutationReferenceParametersDTO.from_dict(outgoing_mutation_reference_parameters_dto_dict)
```
