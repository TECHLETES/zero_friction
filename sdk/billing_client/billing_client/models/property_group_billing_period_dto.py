...
class PropertyGroupBillingPeriodDTO(BaseModel):
    """
    ...
    property_group_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the property group.", alias="propertyGroupId")
    start_date: Optional[datetime] = Field(default=None, description="The start date and time of the billing period.", alias="startDate")
    end_date: Optional[datetime] = Field(default=None, description="The end date and time of the billing period.", alias="endDate")
    incoming_invoice_components: Optional[List[IncomingInvoiceComponentDetailsDTO]] = Field(default=None, description="List of incoming invoice components associated with this billing period.", alias="incomingInvoiceComponents")
    calculation_configurations: Optional[List[PropertyGroupBillingPeriodCalculationConfigurationDetailsDTO]] = Field(default=None, description="List of calculation configurations and their details for this billing period.", alias="calculationConfigurations")
    locked: Optional[StrictBool] = Field(default=None, description="Indicates whether the billing period is locked for modifications.")
    __properties: ClassVar[List[str]] = ["id", "entityType", "createdDateTime", "discriminator", "_etag", "requireAttention", "hasErrors", "hasWarnings", "isReadOnly", "organisationId", "propertyGroupId", "startDate", "endDate", "incomingInvoiceComponents", "calculationConfigurations", "locked"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in incoming_invoice_components (list)
        _items = []
        if self.incoming_invoice_components:
            for _item_incoming_invoice_components in self.incoming_invoice_components:
                if _item_incoming_invoice_components:
                    _items.append(_item_incoming_invoice_components.to_dict())
            _dict['incomingInvoiceComponents'] = _items
        ...
        # set to None if incoming_invoice_components (nullable) is None
        # and model_fields_set contains the field
        if self.incoming_invoice_components is None and "incoming_invoice_components" in self.model_fields_set:
            _dict['incomingInvoiceComponents'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incomingInvoiceComponents": [IncomingInvoiceComponentDetailsDTO.from_dict(_item) for _item in obj["incomingInvoiceComponents"]] if obj.get("incomingInvoiceComponents") is not None else None,
            "calculationConfigurations": [PropertyGroupBillingPeriodCalculationConfigurationDetailsDTO.from_dict(_item) for _item in obj["calculationConfigurations"]] if obj.get("calculationConfigurations") is not None else None,
