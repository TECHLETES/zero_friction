...
class TransactionReferenceParametersDTOInvoiceReferenceParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "invoiceNum", "periodStartDateTime", "periodEndDateTime", "invoiceType"]
