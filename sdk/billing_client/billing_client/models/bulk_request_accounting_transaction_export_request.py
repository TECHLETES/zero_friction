...
class BulkRequestAccountingTransactionExportRequest(BaseModel):
    """
    BulkRequestAccountingTransactionExportRequest
    """ # noqa: E501
    var_query_params: Optional[GetTransactionsQueryParams] = Field(default=None, alias="queryParams")
    ...
    __properties: ClassVar[List[str]] = ["queryParams", "quickFilter", "onlyValidate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queryParams": GetTransactionsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
