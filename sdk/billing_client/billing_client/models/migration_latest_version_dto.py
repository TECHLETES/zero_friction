...
class MigrationLatestVersionDTO(BaseModel):
    """
    MigrationLatestVersionDTO
    """ # noqa: E501
    namespace: Optional[StrictStr] = None
    latest_version: Optional[StrictInt] = Field(default=None, alias="latestVersion")
    __properties: ClassVar[List[str]] = ["namespace", "latestVersion"]
