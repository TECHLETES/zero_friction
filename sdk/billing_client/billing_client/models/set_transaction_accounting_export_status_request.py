...
class SetTransactionAccountingExportStatusRequest(BaseModel):
    """
    SetTransactionAccountingExportStatusRequest
    """ # noqa: E501
    account_export_status: AccountExportStatus = Field(alias="accountExportStatus")
    account_export_details: Optional[AccountExportDetailsDTO] = Field(alias="accountExportDetails")
    __properties: ClassVar[List[str]] = ["accountExportStatus", "accountExportDetails"]
