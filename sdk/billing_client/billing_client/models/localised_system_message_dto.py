...
class LocalisedSystemMessageDTO(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messageValues": [LocalisedSystemMessageDtoValue.from_dict(_item) for _item in obj["messageValues"]] if obj.get("messageValues") is not None else None,
            "level": obj.get("level")
        })
        return _obj
