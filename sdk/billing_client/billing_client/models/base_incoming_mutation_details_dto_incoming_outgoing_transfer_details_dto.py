...
class BaseIncomingMutationDetailsDTOIncomingOutgoingTransferDetailsDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['IncomingOutgoingTransferDetailsDTO']):
            raise ValueError("must be one of enum values ('IncomingOutgoingTransferDetailsDTO')")
        return value
