...
class PaymentCollectionDetailsDTOSctCollectionDetailsDTO(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['SctCollectionDetailsDTO']):
            raise ValueError("must be one of enum values ('SctCollectionDetailsDTO')")
        return value
