...
class BulkMarkCollectionCaseManuallyClosedRequest(BaseModel):
    """
    BulkMarkCollectionCaseManuallyClosedRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[GetCollectionCasesQueryParams] = Field(default=None, alias="queryParams")
    ...
    write_off_handling_type: Optional[WriteOffHandlingType] = Field(default=None, alias="writeOffHandlingType")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "writeOffFees", "writeOffHandlingType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetCollectionCasesQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
            "quickFilter": obj.get("quickFilter"),
            "writeOffFees": obj.get("writeOffFees"),
            "writeOffHandlingType": obj.get("writeOffHandlingType")
        })
        return _obj
