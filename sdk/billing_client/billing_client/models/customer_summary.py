...
class CustomerSummary(BaseModel):
    ...
    customer_account_num: Optional[StrictStr] = Field(default=None, alias="customerAccountNum")
    short_display_name: Optional[StrictStr] = Field(default=None, alias="shortDisplayName")
    __properties: ClassVar[List[str]] = ["customerId", "customerAccountNum", "shortDisplayName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customerAccountNum": obj.get("customerAccountNum"),
