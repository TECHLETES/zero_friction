...
class BulkTriggerBillingCompletenessRequest(BaseModel):
    """
    ...
    only_validate: Optional[StrictBool] = Field(default=None, description="Indicates if only validation should be performed without actual calculation", alias="onlyValidate")
    ...
    __properties: ClassVar[List[str]] = ["onlyAdvances", "recalculateIfNeeded", "advanceUntilDateTime", "onlyValidate", "queryParams", "quickFilter"]
