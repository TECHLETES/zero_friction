...
class BulkTriggerBillingCompletenessRequest(BaseModel):
    ...
    var_query_params: Optional[GetBillingCompletenessQueryParams] = Field(default=None, alias="queryParams")
    ...
    advance_until_date_time: Optional[datetime] = Field(default=None, alias="advanceUntilDateTime")
    ...
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "onlyAdvances", "recalculateIfNeeded", "advanceUntilDateTime", "overrideEstimatedMeasurementCreation"]
