...
class AccountingExportRunErrorDTO(BaseModel):
    """
    AccountingExportRunErrorDTO
    """ # noqa: E501
    error_code: Optional[StrictInt] = Field(default=None, alias="errorCode")
    extra_info: Optional[List[StrictStr]] = Field(default=None, alias="extraInfo")
    __properties: ClassVar[List[str]] = ["errorCode", "extraInfo"]
