...
class BulkChangeNextInvoiceEndDateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "fromFirstOpenPeriod", "endDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fromFirstOpenPeriod": obj.get("fromFirstOpenPeriod"),
