...
class TransactionReferenceParametersDTOPaymentReferenceParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "paymentReference", "remittanceInformation", "paymentDateTime", "paymentMethod", "paymentType", "isManual"]
