...
class CalculationConfigurationBillingItemRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    billing_item_id: Optional[StrictStr] = Field(default=None, description="The ID of the billing item to configure.", alias="billingItemId")
    deviating_tariff_calculation: Optional[StrictBool] = Field(default=None, description="Indicates whether this billing item uses a deviating tariff calculation.", alias="deviatingTariffCalculation")
    tariff_formula: Optional[TariffFormulaDTO] = Field(default=None, description="The tariff formula to be used for calculation when deviating tariff calculation is enabled.", alias="tariffFormula")
    __properties: ClassVar[List[str]] = ["billingItemId", "deviatingTariffCalculation", "tariffFormula"]
