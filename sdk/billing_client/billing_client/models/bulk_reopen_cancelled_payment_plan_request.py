...
class BulkReopenCancelledPaymentPlanRequest(BaseModel):
    """
    BulkReopenCancelledPaymentPlanRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: PaymentPlanQueryParams = Field(alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    recalculate_remaining_installment_dates: Optional[StrictBool] = Field(default=None, alias="recalculateRemainingInstallmentDates")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "recalculateRemainingInstallmentDates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recalculateRemainingInstallmentDates": obj.get("recalculateRemainingInstallmentDates")
        })
        return _obj
