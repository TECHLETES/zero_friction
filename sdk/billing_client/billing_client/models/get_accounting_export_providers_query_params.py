...
class GetAccountingExportProvidersQueryParams(BaseModel):
    """
    GetAccountingExportProvidersQueryParams
    """ # noqa: E501
    statuses: Optional[List[AccountingExportProviderStatus]] = None
    ...
    __properties: ClassVar[List[str]] = ["statuses", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
