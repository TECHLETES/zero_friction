...
class BulkChangeExportStatusRequest(BaseModel):
    """
    ...
    only_validate: Optional[StrictBool] = Field(default=None, description="Indicates if only validation should be performed without actually changing the export status.  When true, the system will only validate if the export status can be changed without making any changes.", alias="onlyValidate")
    ...
    __properties: ClassVar[List[str]] = ["exportStatus", "onlyValidate", "queryParams", "quickFilter"]
