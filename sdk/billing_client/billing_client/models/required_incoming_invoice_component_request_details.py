...
class RequiredIncomingInvoiceComponentRequestDetails(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the incoming invoice component.")
    optional: Optional[StrictBool] = Field(default=None, description="Indicates whether this component is optional in the billing configuration.")
    __properties: ClassVar[List[str]] = ["id", "optional"]
