...
class UpdateAdvancePeriodPercentagesRequest(BaseModel):
    """
    UpdateAdvancePeriodPercentagesRequest
    """ # noqa: E501
    advance_period_percentages: List[AdvancePeriodPercentage] = Field(alias="advancePeriodPercentages")
    __properties: ClassVar[List[str]] = ["advancePeriodPercentages"]
