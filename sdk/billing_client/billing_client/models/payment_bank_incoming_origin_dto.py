...
class PaymentBankIncomingOriginDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["incomingMutationId", "incomingBankingTransactionId", "incomingBankingTransactionIdentification"]
