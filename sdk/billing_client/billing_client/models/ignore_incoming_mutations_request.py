...
class IgnoreIncomingMutationsRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if incoming_mutation_ids (nullable) is None
        # and model_fields_set contains the field
        if self.incoming_mutation_ids is None and "incoming_mutation_ids" in self.model_fields_set:
            _dict['incomingMutationIds'] = None
