...
class BulkSendInvoiceRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "communicationType", "applyStartCommunicationIdempotency"]
