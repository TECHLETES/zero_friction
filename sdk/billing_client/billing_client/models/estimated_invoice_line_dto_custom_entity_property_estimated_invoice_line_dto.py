...
class EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO(BaseModel):
    """
    EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO
    """ # noqa: E501
    type: Optional[StrictStr] = None
    custom_entity_property_entity_subject_type: Optional[EntitySubjectType] = Field(default=None, alias="customEntityPropertyEntitySubjectType")
    custom_entity_property_entity_subject_id: Optional[StrictStr] = Field(default=None, alias="customEntityPropertyEntitySubjectId")
    custom_entity_property_accuracy: Optional[PeriodForEntityDTO] = Field(default=None, alias="customEntityPropertyAccuracy")
    ...
    __properties: ClassVar[List[str]] = ["type", "customEntityPropertyEntitySubjectType", "customEntityPropertyEntitySubjectId", "customEntityPropertyAccuracy", "calculationType", "billingItemReference", "startDateTime", "endDateTime", "amountExclVAT", "vat", "amountInclVAT", "quantity", "rawQuantity", "unitPrice", "vatRate", "unitOfMeasure", "utilityType", "serviceLocationId", "billingTariffAccuracy", "costComponentAccuracies", "taxAccuracy", "accuracy", "quantityAccuracy"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['EstimatedInvoiceLineDTO:CustomEntityProperty']):
            raise ValueError("must be one of enum values ('EstimatedInvoiceLineDTO:CustomEntityProperty')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of custom_entity_property_accuracy
        if self.custom_entity_property_accuracy:
            _dict['customEntityPropertyAccuracy'] = self.custom_entity_property_accuracy.to_dict()
        ...
        # set to None if custom_entity_property_entity_subject_id (nullable) is None
        # and model_fields_set contains the field
        if self.custom_entity_property_entity_subject_id is None and "custom_entity_property_entity_subject_id" in self.model_fields_set:
            _dict['customEntityPropertyEntitySubjectId'] = None

        # set to None if custom_entity_property_accuracy (nullable) is None
        # and model_fields_set contains the field
        if self.custom_entity_property_accuracy is None and "custom_entity_property_accuracy" in self.model_fields_set:
            _dict['customEntityPropertyAccuracy'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "customEntityPropertyEntitySubjectType": obj.get("customEntityPropertyEntitySubjectType"),
            "customEntityPropertyEntitySubjectId": obj.get("customEntityPropertyEntitySubjectId"),
            "customEntityPropertyAccuracy": PeriodForEntityDTO.from_dict(obj["customEntityPropertyAccuracy"]) if obj.get("customEntityPropertyAccuracy") is not None else None,
