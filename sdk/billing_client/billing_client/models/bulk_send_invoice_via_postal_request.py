...
class BulkSendInvoiceViaPostalRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, description="Indicates if only validation should be performed without actually sending the invoices.  When true, the system will only validate if the invoices can be sent without making any changes.", alias="onlyValidate")
    var_query_params: Optional[GetInvoicesQueryParams] = Field(default=None, description="Query parameters to filter the invoices to be sent.", alias="queryParams")
