...
class BulkMarkInvoiceSentSkippedRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, description="Indicates if only validation should be performed without actually marking the invoices as skipped.  When true, the system will only validate if the invoices can be marked as skipped without making any changes.", alias="onlyValidate")
    var_query_params: Optional[GetInvoicesQueryParams] = Field(default=None, description="Query parameters to filter the invoices to be marked as skipped.", alias="queryParams")
