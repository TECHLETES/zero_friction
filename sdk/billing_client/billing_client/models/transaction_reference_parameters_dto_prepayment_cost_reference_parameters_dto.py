...
class TransactionReferenceParametersDTOPrepaymentCostReferenceParametersDTO(BaseModel):
    """
    TransactionReferenceParametersDTOPrepaymentCostReferenceParametersDTO
    """ # noqa: E501
    type: Optional[StrictStr] = None
    prepayment_cost_id: Optional[StrictStr] = Field(default=None, alias="prepaymentCostId")
    ...
    __properties: ClassVar[List[str]] = ["type", "prepaymentCostId", "prepaymentAccountId", "prepaymentAccountNumber", "productionDay", "productionDayStartUtc", "productionDayEndUtc"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PrepaymentCost']):
            raise ValueError("must be one of enum values ('PrepaymentCost')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if prepayment_cost_id (nullable) is None
        # and model_fields_set contains the field
        if self.prepayment_cost_id is None and "prepayment_cost_id" in self.model_fields_set:
            _dict['prepaymentCostId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "prepaymentCostId": obj.get("prepaymentCostId"),
