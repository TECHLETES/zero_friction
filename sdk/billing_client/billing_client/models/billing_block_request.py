...
class BillingBlockRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="A comment explaining the reason for blocking the billing relation.")
