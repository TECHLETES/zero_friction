...
class RequiredQuantityValidationErrorDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of problem_entity
        if self.problem_entity:
            _dict['problemEntity'] = self.problem_entity.to_dict()
        # override the default output from pydantic by calling `to_dict()` of impacted_entity
        if self.impacted_entity:
            _dict['impactedEntity'] = self.impacted_entity.to_dict()
        ...
        if self.problem_entity is None and "problem_entity" in self.model_fields_set:
            _dict['problemEntity'] = None

        # set to None if impacted_entity (nullable) is None
        # and model_fields_set contains the field
        if self.impacted_entity is None and "impacted_entity" in self.model_fields_set:
            _dict['impactedEntity'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": obj.get("error"),
            "problemEntity": ReasonEntityDTO.from_dict(obj["problemEntity"]) if obj.get("problemEntity") is not None else None,
            "impactedEntity": ImpactedEntityDTO.from_dict(obj["impactedEntity"]) if obj.get("impactedEntity") is not None else None,
