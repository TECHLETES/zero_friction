...
class CustomEntityPropertyValueDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["valueDecimal", "valueString", "valueBoolean", "valueNumber", "valueDateTime", "valueDropdown", "startDateTime", "endDateTime"]
