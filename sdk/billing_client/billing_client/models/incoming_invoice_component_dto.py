...
class IncomingInvoiceComponentDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the incoming invoice component.")
    optional: Optional[StrictBool] = Field(default=None, description="Indicates whether this component is optional.")
