...
class TransactionReferenceParametersDTOPrepaymentTopUpReferenceParametersDTO(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PrepaymentTopUp']):
            raise ValueError("must be one of enum values ('PrepaymentTopUp')")
        return value
