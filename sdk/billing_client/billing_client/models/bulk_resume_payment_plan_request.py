...
class BulkResumePaymentPlanRequest(BaseModel):
    """
    ...
    recalculate_installments: Optional[StrictBool] = Field(default=None, alias="recalculateInstallments")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "recalculateInstallments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recalculateInstallments": obj.get("recalculateInstallments")
        })
        return _obj
