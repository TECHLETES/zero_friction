...
class TransactionReferenceParametersDTOIgnoredIncomingBankingMutationReferenceParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "incomingBankingTransactionId", "incomingMutationId", "description"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['IgnoredIncomingMutation']):
            raise ValueError("must be one of enum values ('IgnoredIncomingMutation')")
        return value
