...
class BulkProcessIncomingBankingTransactionRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, description="Indicates whether this is a validation-only request without actual processing.", alias="onlyValidate")
    var_query_params: Optional[GetIncomingBankingTransactionsQueryParams] = Field(default=None, description="Query parameters to filter the transactions to be processed.", alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, description="A quick filter string to further refine the selection of transactions to be processed.", alias="quickFilter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetIncomingBankingTransactionsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
