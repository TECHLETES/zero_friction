...
class GetAccountingExportRunsQueryParams(BaseModel):
    """
    ...
    statuses: Optional[List[AccountingExportRunStatus]] = None
    ...
    __properties: ClassVar[List[str]] = ["providerId", "providerType", "statuses", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
