...
class TransactionReferenceParametersDTOPrepaymentGiftReferenceParametersDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "paymentReference", "remittanceInformation", "paymentDateTime", "paymentMethod", "paymentType", "isManual", "prepaymentAccountId"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PrepaymentGift']):
            raise ValueError("must be one of enum values ('PrepaymentGift')")
        return value
