...
class BulkSendAnnualStatementViaPostalRequest(BaseModel):
    """
    BulkSendAnnualStatementViaPostalRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[GetAnnualStatementsQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    apply_start_communication_idempotency: Optional[StrictBool] = Field(default=None, alias="applyStartCommunicationIdempotency")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "applyStartCommunicationIdempotency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetAnnualStatementsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
            "quickFilter": obj.get("quickFilter"),
            "applyStartCommunicationIdempotency": obj.get("applyStartCommunicationIdempotency")
        })
        return _obj
