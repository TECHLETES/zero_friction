...
class BulkDeleteOutgoingMutationRequest(BaseModel):
    """
    ...
    var_query_params: Optional[GetOutgoingMutationsQueryParams] = Field(default=None, description="Query parameters to filter the mutations to be deleted.", alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, description="A quick filter string to further refine the selection of mutations to be deleted.", alias="quickFilter")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetOutgoingMutationsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
