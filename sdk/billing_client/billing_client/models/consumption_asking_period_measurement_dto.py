...
class ConsumptionAskingPeriodMeasurementDTO(BaseModel):
    """
    ConsumptionAskingPeriodMeasurementDTO
    """ # noqa: E501
    measurement_date_time: Optional[datetime] = Field(default=None, alias="measurementDateTime")
    ...
    __properties: ClassVar[List[str]] = ["measurementDateTime", "value", "readingOrigin", "readingMethod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "measurementDateTime": obj.get("measurementDateTime"),
            "value": obj.get("value"),
