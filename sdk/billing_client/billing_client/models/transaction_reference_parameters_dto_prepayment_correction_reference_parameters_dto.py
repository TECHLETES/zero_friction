...
class TransactionReferenceParametersDTOPrepaymentCorrectionReferenceParametersDTO(BaseModel):
    """
    ...
    is_psp_refund: Optional[StrictBool] = Field(default=None, alias="isPspRefund")
    __properties: ClassVar[List[str]] = ["type", "paymentReference", "remittanceInformation", "paymentDateTime", "paymentMethod", "paymentType", "isManual", "prepaymentAccountId", "isPspRefund"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['PrepaymentCorrection']):
            raise ValueError("must be one of enum values ('PrepaymentCorrection')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isPspRefund": obj.get("isPspRefund")
        })
        return _obj
