...
class CustomersApi:
    ...
    @validate_call
    def get_customers_customeruuid(
        self,
        ...
        _param = self._get_customers_customeruuid_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '404': "ProblemDetails",
            '200': "BillingCustomerDTOApiResponseDTO",
        }
    ...
    @validate_call
    def get_customers_customeruuid_with_http_info(
        self,
        customeruuid: Annotated[StrictStr, Field(description="The UUID of the customer.")],
        zf_tuuid: Annotated[StrictStr, Field(description="Format - uuid. Tenant ID")],
        zf_ouuid: Annotated[StrictStr, Field(description="Format - uuid. Organisation ID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BillingCustomerDTOApiResponseDTO]:
        """Retrieves a billing customer by their UUID.
    ...
    @validate_call
    def get_customers_customeruuid_without_preload_content(
        self,
        customeruuid: Annotated[StrictStr, Field(description="The UUID of the customer.")],
        zf_tuuid: Annotated[StrictStr, Field(description="Format - uuid. Tenant ID")],
        zf_ouuid: Annotated[StrictStr, Field(description="Format - uuid. Organisation ID")],
    ...
    def _get_customers_customeruuid_serialize(
        self,
        customeruuid,
        zf_tuuid,
        zf_ouuid,
