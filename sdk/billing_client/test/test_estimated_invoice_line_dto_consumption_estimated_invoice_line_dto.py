...
class TestEstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO(unittest.TestCase):
    """EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO:
        """Test EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO`
        """
        model = EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO()
        if include_optional:
            return EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO(
    ...
    def testEstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO(self):
        """Test EstimatedInvoiceLineDTOConsumptionEstimatedInvoiceLineDTO"""
