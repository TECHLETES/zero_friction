...
class TestAnnualStatementDTOApiResponseDTO(unittest.TestCase):
    """AnnualStatementDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnnualStatementDTOApiResponseDTO:
        """Test AnnualStatementDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnnualStatementDTOApiResponseDTO`
        """
        model = AnnualStatementDTOApiResponseDTO()
        if include_optional:
            return AnnualStatementDTOApiResponseDTO(
                errors = [
    ...
    def testAnnualStatementDTOApiResponseDTO(self):
        """Test AnnualStatementDTOApiResponseDTO"""
