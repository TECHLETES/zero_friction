...
class TestBillingRelationDTOPagedResponseModelDTOApiResponseDTO(unittest.TestCase):
    """BillingRelationDTOPagedResponseModelDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingRelationDTOPagedResponseModelDTOApiResponseDTO:
        """Test BillingRelationDTOPagedResponseModelDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingRelationDTOPagedResponseModelDTOApiResponseDTO`
        """
        model = BillingRelationDTOPagedResponseModelDTOApiResponseDTO()
        if include_optional:
            return BillingRelationDTOPagedResponseModelDTOApiResponseDTO(
                errors = [
                ...
                is_synchronous = True,
                data = billing_client.models.billing_relation_dto_paged_response_model_dto.BillingRelationDTOPagedResponseModelDTO(
                    results = [
    ...
    def testBillingRelationDTOPagedResponseModelDTOApiResponseDTO(self):
        """Test BillingRelationDTOPagedResponseModelDTOApiResponseDTO"""
