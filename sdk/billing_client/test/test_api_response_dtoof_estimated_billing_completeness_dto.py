...
class TestApiResponseDTOOfEstimatedBillingCompletenessDTO(unittest.TestCase):
    """ApiResponseDTOOfEstimatedBillingCompletenessDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfEstimatedBillingCompletenessDTO:
        """Test ApiResponseDTOOfEstimatedBillingCompletenessDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfEstimatedBillingCompletenessDTO`
        """
        model = ApiResponseDTOOfEstimatedBillingCompletenessDTO()
        if include_optional:
            return ApiResponseDTOOfEstimatedBillingCompletenessDTO(
    ...
    def testApiResponseDTOOfEstimatedBillingCompletenessDTO(self):
        """Test ApiResponseDTOOfEstimatedBillingCompletenessDTO"""
