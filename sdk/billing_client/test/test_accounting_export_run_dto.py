...
class TestAccountingExportRunDTO(unittest.TestCase):
    """AccountingExportRunDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountingExportRunDTO:
        """Test AccountingExportRunDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountingExportRunDTO`
        """
        model = AccountingExportRunDTO()
        if include_optional:
            return AccountingExportRunDTO(
    ...
    def testAccountingExportRunDTO(self):
        """Test AccountingExportRunDTO"""
