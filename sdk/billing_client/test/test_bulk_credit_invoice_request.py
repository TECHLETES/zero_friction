...
class TestBulkCreditInvoiceRequest(unittest.TestCase):
    """BulkCreditInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkCreditInvoiceRequest:
        """Test BulkCreditInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkCreditInvoiceRequest`
        """
        model = BulkCreditInvoiceRequest()
        if include_optional:
            return BulkCreditInvoiceRequest(
                only_validate = True,
    ...
    def testBulkCreditInvoiceRequest(self):
        """Test BulkCreditInvoiceRequest"""
