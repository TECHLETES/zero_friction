...
class TestBulkSendInvoiceViaPostalRequest(unittest.TestCase):
    """BulkSendInvoiceViaPostalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSendInvoiceViaPostalRequest:
        """Test BulkSendInvoiceViaPostalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSendInvoiceViaPostalRequest`
        """
        model = BulkSendInvoiceViaPostalRequest()
        if include_optional:
            return BulkSendInvoiceViaPostalRequest(
                only_validate = True,
    ...
    def testBulkSendInvoiceViaPostalRequest(self):
        """Test BulkSendInvoiceViaPostalRequest"""
