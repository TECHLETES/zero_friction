...
class TestApiResponseDTOOfPaymentDTO(unittest.TestCase):
    """ApiResponseDTOOfPaymentDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPaymentDTO:
        """Test ApiResponseDTOOfPaymentDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPaymentDTO`
        """
        model = ApiResponseDTOOfPaymentDTO()
        if include_optional:
            return ApiResponseDTOOfPaymentDTO(
    ...
    def testApiResponseDTOOfPaymentDTO(self):
        """Test ApiResponseDTOOfPaymentDTO"""
