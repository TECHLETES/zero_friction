...
class TestPagedResponseModelDTOOfAccountingExportRunDTO(unittest.TestCase):
    """PagedResponseModelDTOOfAccountingExportRunDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfAccountingExportRunDTO:
        """Test PagedResponseModelDTOOfAccountingExportRunDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfAccountingExportRunDTO`
        """
        model = PagedResponseModelDTOOfAccountingExportRunDTO()
        if include_optional:
            return PagedResponseModelDTOOfAccountingExportRunDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfAccountingExportRunDTO(self):
        """Test PagedResponseModelDTOOfAccountingExportRunDTO"""
