...
class TestBulkReopenBillingCompletenessRequest(unittest.TestCase):
    """BulkReopenBillingCompletenessRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkReopenBillingCompletenessRequest:
        """Test BulkReopenBillingCompletenessRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkReopenBillingCompletenessRequest`
        """
        model = BulkReopenBillingCompletenessRequest()
        if include_optional:
            return BulkReopenBillingCompletenessRequest(
                only_validate = True,
    ...
    def testBulkReopenBillingCompletenessRequest(self):
        """Test BulkReopenBillingCompletenessRequest"""
