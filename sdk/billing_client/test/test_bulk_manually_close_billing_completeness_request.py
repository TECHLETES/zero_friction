...
class TestBulkManuallyCloseBillingCompletenessRequest(unittest.TestCase):
    """BulkManuallyCloseBillingCompletenessRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkManuallyCloseBillingCompletenessRequest:
        """Test BulkManuallyCloseBillingCompletenessRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkManuallyCloseBillingCompletenessRequest`
        """
        model = BulkManuallyCloseBillingCompletenessRequest()
        if include_optional:
            return BulkManuallyCloseBillingCompletenessRequest(
                only_validate = True,
    ...
    def testBulkManuallyCloseBillingCompletenessRequest(self):
        """Test BulkManuallyCloseBillingCompletenessRequest"""
