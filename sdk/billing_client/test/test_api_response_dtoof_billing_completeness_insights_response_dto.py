...
class TestApiResponseDTOOfBillingCompletenessInsightsResponseDTO(unittest.TestCase):
    """ApiResponseDTOOfBillingCompletenessInsightsResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfBillingCompletenessInsightsResponseDTO:
        """Test ApiResponseDTOOfBillingCompletenessInsightsResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfBillingCompletenessInsightsResponseDTO`
        """
        model = ApiResponseDTOOfBillingCompletenessInsightsResponseDTO()
        if include_optional:
            return ApiResponseDTOOfBillingCompletenessInsightsResponseDTO(
    ...
    def testApiResponseDTOOfBillingCompletenessInsightsResponseDTO(self):
        """Test ApiResponseDTOOfBillingCompletenessInsightsResponseDTO"""
