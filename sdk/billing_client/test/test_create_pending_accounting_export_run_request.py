...
class TestCreatePendingAccountingExportRunRequest(unittest.TestCase):
    """CreatePendingAccountingExportRunRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePendingAccountingExportRunRequest:
        """Test CreatePendingAccountingExportRunRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePendingAccountingExportRunRequest`
        """
        model = CreatePendingAccountingExportRunRequest()
        if include_optional:
            return CreatePendingAccountingExportRunRequest(
                provider_id = '',
    ...
    def testCreatePendingAccountingExportRunRequest(self):
        """Test CreatePendingAccountingExportRunRequest"""
