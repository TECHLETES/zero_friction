...
class TestIncomingBankingTransactionDTOPagedResponseModelDTO(unittest.TestCase):
    """IncomingBankingTransactionDTOPagedResponseModelDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingBankingTransactionDTOPagedResponseModelDTO:
        """Test IncomingBankingTransactionDTOPagedResponseModelDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingBankingTransactionDTOPagedResponseModelDTO`
        """
        model = IncomingBankingTransactionDTOPagedResponseModelDTO()
        if include_optional:
            return IncomingBankingTransactionDTOPagedResponseModelDTO(
                results = [
    ...
    def testIncomingBankingTransactionDTOPagedResponseModelDTO(self):
        """Test IncomingBankingTransactionDTOPagedResponseModelDTO"""
