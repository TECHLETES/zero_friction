...
class TestApiResponseDTOOfBillingRelationDTO(unittest.TestCase):
    """ApiResponseDTOOfBillingRelationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfBillingRelationDTO:
        """Test ApiResponseDTOOfBillingRelationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfBillingRelationDTO`
        """
        model = ApiResponseDTOOfBillingRelationDTO()
        if include_optional:
            return ApiResponseDTOOfBillingRelationDTO(
    ...
    def testApiResponseDTOOfBillingRelationDTO(self):
        """Test ApiResponseDTOOfBillingRelationDTO"""
