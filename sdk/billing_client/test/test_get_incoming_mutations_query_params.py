...
class TestGetIncomingMutationsQueryParams(unittest.TestCase):
    """GetIncomingMutationsQueryParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetIncomingMutationsQueryParams:
        """Test GetIncomingMutationsQueryParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetIncomingMutationsQueryParams`
        """
    ...
    def testGetIncomingMutationsQueryParams(self):
        """Test GetIncomingMutationsQueryParams"""
