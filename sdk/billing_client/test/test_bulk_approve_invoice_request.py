...
class TestBulkApproveInvoiceRequest(unittest.TestCase):
    """BulkApproveInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkApproveInvoiceRequest:
        """Test BulkApproveInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkApproveInvoiceRequest`
        """
        model = BulkApproveInvoiceRequest()
        if include_optional:
            return BulkApproveInvoiceRequest(
    ...
    def testBulkApproveInvoiceRequest(self):
        """Test BulkApproveInvoiceRequest"""
