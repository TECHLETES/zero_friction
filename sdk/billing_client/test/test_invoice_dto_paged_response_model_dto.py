...
class TestInvoiceDTOPagedResponseModelDTO(unittest.TestCase):
    """InvoiceDTOPagedResponseModelDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvoiceDTOPagedResponseModelDTO:
        """Test InvoiceDTOPagedResponseModelDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvoiceDTOPagedResponseModelDTO`
        """
        model = InvoiceDTOPagedResponseModelDTO()
        if include_optional:
            return InvoiceDTOPagedResponseModelDTO(
                results = [
    ...
    def testInvoiceDTOPagedResponseModelDTO(self):
        """Test InvoiceDTOPagedResponseModelDTO"""
