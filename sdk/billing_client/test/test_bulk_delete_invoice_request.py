...
class TestBulkDeleteInvoiceRequest(unittest.TestCase):
    """BulkDeleteInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteInvoiceRequest:
        """Test BulkDeleteInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteInvoiceRequest`
        """
        model = BulkDeleteInvoiceRequest()
        if include_optional:
            return BulkDeleteInvoiceRequest(
                only_validate = True,
    ...
    def testBulkDeleteInvoiceRequest(self):
        """Test BulkDeleteInvoiceRequest"""
