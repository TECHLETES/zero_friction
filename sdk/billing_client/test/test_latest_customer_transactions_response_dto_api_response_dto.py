...
class TestLatestCustomerTransactionsResponseDTOApiResponseDTO(unittest.TestCase):
    """LatestCustomerTransactionsResponseDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LatestCustomerTransactionsResponseDTOApiResponseDTO:
        """Test LatestCustomerTransactionsResponseDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LatestCustomerTransactionsResponseDTOApiResponseDTO`
        """
        model = LatestCustomerTransactionsResponseDTOApiResponseDTO()
        if include_optional:
            return LatestCustomerTransactionsResponseDTOApiResponseDTO(
                errors = [
    ...
    def testLatestCustomerTransactionsResponseDTOApiResponseDTO(self):
        """Test LatestCustomerTransactionsResponseDTOApiResponseDTO"""
