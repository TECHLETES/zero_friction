...
class TestBulkChangeExportStatusRequest(unittest.TestCase):
    """BulkChangeExportStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkChangeExportStatusRequest:
        """Test BulkChangeExportStatusRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkChangeExportStatusRequest`
        """
        model = BulkChangeExportStatusRequest()
        if include_optional:
            return BulkChangeExportStatusRequest(
    ...
    def testBulkChangeExportStatusRequest(self):
        """Test BulkChangeExportStatusRequest"""
