...
class TestPagedResponseModelDTOOfCollectionCaseDTO(unittest.TestCase):
    """PagedResponseModelDTOOfCollectionCaseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfCollectionCaseDTO:
        """Test PagedResponseModelDTOOfCollectionCaseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfCollectionCaseDTO`
        """
        model = PagedResponseModelDTOOfCollectionCaseDTO()
        if include_optional:
            return PagedResponseModelDTOOfCollectionCaseDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfCollectionCaseDTO(self):
        """Test PagedResponseModelDTOOfCollectionCaseDTO"""
