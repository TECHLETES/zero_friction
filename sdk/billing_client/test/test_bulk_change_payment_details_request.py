...
class TestBulkChangePaymentDetailsRequest(unittest.TestCase):
    """BulkChangePaymentDetailsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkChangePaymentDetailsRequest:
        """Test BulkChangePaymentDetailsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkChangePaymentDetailsRequest`
        """
    ...
    def testBulkChangePaymentDetailsRequest(self):
        """Test BulkChangePaymentDetailsRequest"""
