...
class TestSubscriptionAskingPeriodDTO(unittest.TestCase):
    """SubscriptionAskingPeriodDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionAskingPeriodDTO:
        """Test SubscriptionAskingPeriodDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionAskingPeriodDTO`
        """
        model = SubscriptionAskingPeriodDTO()
        if include_optional:
            return SubscriptionAskingPeriodDTO(
    ...
    def testSubscriptionAskingPeriodDTO(self):
        """Test SubscriptionAskingPeriodDTO"""
