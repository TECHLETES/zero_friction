...
class TestBulkDeleteOutgoingBankingTransactionRequest(unittest.TestCase):
    """BulkDeleteOutgoingBankingTransactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteOutgoingBankingTransactionRequest:
        """Test BulkDeleteOutgoingBankingTransactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteOutgoingBankingTransactionRequest`
        """
        model = BulkDeleteOutgoingBankingTransactionRequest()
        if include_optional:
    ...
    def testBulkDeleteOutgoingBankingTransactionRequest(self):
        """Test BulkDeleteOutgoingBankingTransactionRequest"""
