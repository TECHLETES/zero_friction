...
class TestCustAgingLineDTO(unittest.TestCase):
    """CustAgingLineDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustAgingLineDTO:
        """Test CustAgingLineDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustAgingLineDTO`
        """
        model = CustAgingLineDTO()
        if include_optional:
