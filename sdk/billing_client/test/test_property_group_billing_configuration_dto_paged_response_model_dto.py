...
class TestPropertyGroupBillingConfigurationDTOPagedResponseModelDTO(unittest.TestCase):
    """PropertyGroupBillingConfigurationDTOPagedResponseModelDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyGroupBillingConfigurationDTOPagedResponseModelDTO:
        """Test PropertyGroupBillingConfigurationDTOPagedResponseModelDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyGroupBillingConfigurationDTOPagedResponseModelDTO`
        """
        model = PropertyGroupBillingConfigurationDTOPagedResponseModelDTO()
        if include_optional:
            return PropertyGroupBillingConfigurationDTOPagedResponseModelDTO(
                results = [
    ...
    def testPropertyGroupBillingConfigurationDTOPagedResponseModelDTO(self):
        """Test PropertyGroupBillingConfigurationDTOPagedResponseModelDTO"""
