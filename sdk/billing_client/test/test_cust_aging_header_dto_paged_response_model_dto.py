...
class TestCustAgingHeaderDTOPagedResponseModelDTO(unittest.TestCase):
    """CustAgingHeaderDTOPagedResponseModelDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustAgingHeaderDTOPagedResponseModelDTO:
        """Test CustAgingHeaderDTOPagedResponseModelDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustAgingHeaderDTOPagedResponseModelDTO`
        """
        model = CustAgingHeaderDTOPagedResponseModelDTO()
        if include_optional:
            return CustAgingHeaderDTOPagedResponseModelDTO(
                results = [
    ...
    def testCustAgingHeaderDTOPagedResponseModelDTO(self):
        """Test CustAgingHeaderDTOPagedResponseModelDTO"""
