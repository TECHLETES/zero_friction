...
class TestUpdateCustomerBankAccountRequest(unittest.TestCase):
    """UpdateCustomerBankAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCustomerBankAccountRequest:
        """Test UpdateCustomerBankAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCustomerBankAccountRequest`
        """
    ...
    def testUpdateCustomerBankAccountRequest(self):
        """Test UpdateCustomerBankAccountRequest"""
