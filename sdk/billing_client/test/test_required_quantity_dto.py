...
class TestRequiredQuantityDTO(unittest.TestCase):
    """RequiredQuantityDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredQuantityDTO:
        """Test RequiredQuantityDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredQuantityDTO`
        """
    ...
    def testRequiredQuantityDTO(self):
        """Test RequiredQuantityDTO"""
