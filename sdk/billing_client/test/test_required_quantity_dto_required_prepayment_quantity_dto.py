...
class TestRequiredQuantityDTORequiredPrepaymentQuantityDTO(unittest.TestCase):
    """RequiredQuantityDTORequiredPrepaymentQuantityDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredQuantityDTORequiredPrepaymentQuantityDTO:
        """Test RequiredQuantityDTORequiredPrepaymentQuantityDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredQuantityDTORequiredPrepaymentQuantityDTO`
        """
        model = RequiredQuantityDTORequiredPrepaymentQuantityDTO()
        if include_optional:
            return RequiredQuantityDTORequiredPrepaymentQuantityDTO(
                type = 'RequiredPrepaymentQuantityDTO',
    ...
    def testRequiredQuantityDTORequiredPrepaymentQuantityDTO(self):
        """Test RequiredQuantityDTORequiredPrepaymentQuantityDTO"""
