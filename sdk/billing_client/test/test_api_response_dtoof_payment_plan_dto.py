...
class TestApiResponseDTOOfPaymentPlanDTO(unittest.TestCase):
    """ApiResponseDTOOfPaymentPlanDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPaymentPlanDTO:
        """Test ApiResponseDTOOfPaymentPlanDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPaymentPlanDTO`
        """
        model = ApiResponseDTOOfPaymentPlanDTO()
        if include_optional:
            return ApiResponseDTOOfPaymentPlanDTO(
                data = billing_client.models.payment_plan_dto.PaymentPlanDTO(
                    payment_plan_number = '', 
                    sequence_num = 56, 
                    status = 'draft', 
                    total_amount = 1.337, 
    ...
    def testApiResponseDTOOfPaymentPlanDTO(self):
        """Test ApiResponseDTOOfPaymentPlanDTO"""
