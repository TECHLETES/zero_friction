...
class TestPagedResponseModelDTOOfBillingRelationDTO(unittest.TestCase):
    """PagedResponseModelDTOOfBillingRelationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfBillingRelationDTO:
        """Test PagedResponseModelDTOOfBillingRelationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfBillingRelationDTO`
        """
        model = PagedResponseModelDTOOfBillingRelationDTO()
        if include_optional:
            return PagedResponseModelDTOOfBillingRelationDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfBillingRelationDTO(self):
        """Test PagedResponseModelDTOOfBillingRelationDTO"""
