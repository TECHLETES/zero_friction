...
class TestRequiredQuantityContractGroupedDTO(unittest.TestCase):
    """RequiredQuantityContractGroupedDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredQuantityContractGroupedDTO:
        """Test RequiredQuantityContractGroupedDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredQuantityContractGroupedDTO`
        """
        model = RequiredQuantityContractGroupedDTO()
        if include_optional:
            return RequiredQuantityContractGroupedDTO(
                billing_item_id = '',
                required_quantities = [
    ...
    def testRequiredQuantityContractGroupedDTO(self):
        """Test RequiredQuantityContractGroupedDTO"""
