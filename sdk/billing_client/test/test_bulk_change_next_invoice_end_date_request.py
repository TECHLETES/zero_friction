...
class TestBulkChangeNextInvoiceEndDateRequest(unittest.TestCase):
    """BulkChangeNextInvoiceEndDateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkChangeNextInvoiceEndDateRequest:
        """Test BulkChangeNextInvoiceEndDateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkChangeNextInvoiceEndDateRequest`
        """
        model = BulkChangeNextInvoiceEndDateRequest()
        if include_optional:
            return BulkChangeNextInvoiceEndDateRequest(
                only_validate = True,
    ...
    def testBulkChangeNextInvoiceEndDateRequest(self):
        """Test BulkChangeNextInvoiceEndDateRequest"""
