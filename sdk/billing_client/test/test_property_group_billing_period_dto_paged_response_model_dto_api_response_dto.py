...
class TestPropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO(unittest.TestCase):
    """PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO:
        """Test PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO`
        """
        model = PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO()
        if include_optional:
            return PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO(
                errors = [
                ...
                is_synchronous = True,
                data = billing_client.models.property_group_billing_period_dto_paged_response_model_dto.PropertyGroupBillingPeriodDTOPagedResponseModelDTO(
                    results = [
    ...
    def testPropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO(self):
        """Test PropertyGroupBillingPeriodDTOPagedResponseModelDTOApiResponseDTO"""
