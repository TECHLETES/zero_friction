...
class TestBulkMarkInvoiceSentRequest(unittest.TestCase):
    """BulkMarkInvoiceSentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkMarkInvoiceSentRequest:
        """Test BulkMarkInvoiceSentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkMarkInvoiceSentRequest`
        """
        model = BulkMarkInvoiceSentRequest()
        if include_optional:
            return BulkMarkInvoiceSentRequest(
                only_validate = True,
    ...
    def testBulkMarkInvoiceSentRequest(self):
        """Test BulkMarkInvoiceSentRequest"""
