...
class TestApiResponseDTOOfListOfIncomingBankingTransactionDTO(unittest.TestCase):
    """ApiResponseDTOOfListOfIncomingBankingTransactionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfListOfIncomingBankingTransactionDTO:
        """Test ApiResponseDTOOfListOfIncomingBankingTransactionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfListOfIncomingBankingTransactionDTO`
        """
        model = ApiResponseDTOOfListOfIncomingBankingTransactionDTO()
        if include_optional:
            return ApiResponseDTOOfListOfIncomingBankingTransactionDTO(
                data = [
    ...
    def testApiResponseDTOOfListOfIncomingBankingTransactionDTO(self):
        """Test ApiResponseDTOOfListOfIncomingBankingTransactionDTO"""
