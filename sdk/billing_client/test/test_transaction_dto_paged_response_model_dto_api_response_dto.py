...
class TestTransactionDTOPagedResponseModelDTOApiResponseDTO(unittest.TestCase):
    """TransactionDTOPagedResponseModelDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionDTOPagedResponseModelDTOApiResponseDTO:
        """Test TransactionDTOPagedResponseModelDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionDTOPagedResponseModelDTOApiResponseDTO`
        """
        model = TransactionDTOPagedResponseModelDTOApiResponseDTO()
        if include_optional:
            return TransactionDTOPagedResponseModelDTOApiResponseDTO(
                errors = [
                ...
                is_synchronous = True,
                data = billing_client.models.transaction_dto_paged_response_model_dto.TransactionDTOPagedResponseModelDTO(
                    results = [
    ...
    def testTransactionDTOPagedResponseModelDTOApiResponseDTO(self):
        """Test TransactionDTOPagedResponseModelDTOApiResponseDTO"""
