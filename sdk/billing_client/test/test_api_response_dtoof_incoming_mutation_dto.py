...
class TestApiResponseDTOOfIncomingMutationDTO(unittest.TestCase):
    """ApiResponseDTOOfIncomingMutationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfIncomingMutationDTO:
        """Test ApiResponseDTOOfIncomingMutationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfIncomingMutationDTO`
        """
        model = ApiResponseDTOOfIncomingMutationDTO()
        if include_optional:
            return ApiResponseDTOOfIncomingMutationDTO(
    ...
    def testApiResponseDTOOfIncomingMutationDTO(self):
        """Test ApiResponseDTOOfIncomingMutationDTO"""
