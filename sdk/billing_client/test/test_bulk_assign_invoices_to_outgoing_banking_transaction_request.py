...
class TestBulkAssignInvoicesToOutgoingBankingTransactionRequest(unittest.TestCase):
    """BulkAssignInvoicesToOutgoingBankingTransactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkAssignInvoicesToOutgoingBankingTransactionRequest:
        """Test BulkAssignInvoicesToOutgoingBankingTransactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkAssignInvoicesToOutgoingBankingTransactionRequest`
        """
    ...
    def testBulkAssignInvoicesToOutgoingBankingTransactionRequest(self):
        """Test BulkAssignInvoicesToOutgoingBankingTransactionRequest"""
