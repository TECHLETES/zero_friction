...
class TestPagedResponseModelDTOOfTransactionDTO(unittest.TestCase):
    """PagedResponseModelDTOOfTransactionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfTransactionDTO:
        """Test PagedResponseModelDTOOfTransactionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfTransactionDTO`
        """
        model = PagedResponseModelDTOOfTransactionDTO()
        if include_optional:
            return PagedResponseModelDTOOfTransactionDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfTransactionDTO(self):
        """Test PagedResponseModelDTOOfTransactionDTO"""
