...
class TestBulkSendInvoiceRequest(unittest.TestCase):
    """BulkSendInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSendInvoiceRequest:
        """Test BulkSendInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSendInvoiceRequest`
        """
        model = BulkSendInvoiceRequest()
        if include_optional:
            return BulkSendInvoiceRequest(
                only_validate = True,
    ...
    def testBulkSendInvoiceRequest(self):
        """Test BulkSendInvoiceRequest"""
