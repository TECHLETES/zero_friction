...
class TestPrepaymentAskingPeriodDTO(unittest.TestCase):
    """PrepaymentAskingPeriodDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrepaymentAskingPeriodDTO:
        """Test PrepaymentAskingPeriodDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrepaymentAskingPeriodDTO`
        """
        model = PrepaymentAskingPeriodDTO()
        if include_optional:
            return PrepaymentAskingPeriodDTO(
    ...
    def testPrepaymentAskingPeriodDTO(self):
        """Test PrepaymentAskingPeriodDTO"""
