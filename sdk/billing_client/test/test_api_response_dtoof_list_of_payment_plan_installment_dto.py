...
class TestApiResponseDTOOfListOfPaymentPlanInstallmentDTO(unittest.TestCase):
    """ApiResponseDTOOfListOfPaymentPlanInstallmentDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfListOfPaymentPlanInstallmentDTO:
        """Test ApiResponseDTOOfListOfPaymentPlanInstallmentDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfListOfPaymentPlanInstallmentDTO`
        """
        model = ApiResponseDTOOfListOfPaymentPlanInstallmentDTO()
        if include_optional:
            return ApiResponseDTOOfListOfPaymentPlanInstallmentDTO(
                data = [
    ...
    def testApiResponseDTOOfListOfPaymentPlanInstallmentDTO(self):
        """Test ApiResponseDTOOfListOfPaymentPlanInstallmentDTO"""
