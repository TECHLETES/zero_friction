...
class TestBillingCompletenessDTOPagedResponseModelDTOApiResponseDTO(unittest.TestCase):
    """BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO:
        """Test BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO`
        """
        model = BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO()
        if include_optional:
            return BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO(
                errors = [
                ...
                is_synchronous = True,
                data = billing_client.models.billing_completeness_dto_paged_response_model_dto.BillingCompletenessDTOPagedResponseModelDTO(
                    results = [
    ...
    def testBillingCompletenessDTOPagedResponseModelDTOApiResponseDTO(self):
        """Test BillingCompletenessDTOPagedResponseModelDTOApiResponseDTO"""
