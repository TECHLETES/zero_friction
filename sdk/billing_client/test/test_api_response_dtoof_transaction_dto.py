...
class TestApiResponseDTOOfTransactionDTO(unittest.TestCase):
    """ApiResponseDTOOfTransactionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfTransactionDTO:
        """Test ApiResponseDTOOfTransactionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfTransactionDTO`
        """
        model = ApiResponseDTOOfTransactionDTO()
        if include_optional:
            return ApiResponseDTOOfTransactionDTO(
                data = billing_client.models.transaction_dto.TransactionDTO(
    ...
    def testApiResponseDTOOfTransactionDTO(self):
        """Test ApiResponseDTOOfTransactionDTO"""
