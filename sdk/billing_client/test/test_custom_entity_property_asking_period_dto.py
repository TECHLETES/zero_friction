...
class TestCustomEntityPropertyAskingPeriodDTO(unittest.TestCase):
    """CustomEntityPropertyAskingPeriodDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomEntityPropertyAskingPeriodDTO:
        """Test CustomEntityPropertyAskingPeriodDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomEntityPropertyAskingPeriodDTO`
        """
        model = CustomEntityPropertyAskingPeriodDTO()
        if include_optional:
            return CustomEntityPropertyAskingPeriodDTO(
    ...
    def testCustomEntityPropertyAskingPeriodDTO(self):
        """Test CustomEntityPropertyAskingPeriodDTO"""
