...
class TestPagedResponseModelDTOOfCustAgingLineDTO(unittest.TestCase):
    """PagedResponseModelDTOOfCustAgingLineDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfCustAgingLineDTO:
        """Test PagedResponseModelDTOOfCustAgingLineDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfCustAgingLineDTO`
        """
        model = PagedResponseModelDTOOfCustAgingLineDTO()
        if include_optional:
            return PagedResponseModelDTOOfCustAgingLineDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfCustAgingLineDTO(self):
        """Test PagedResponseModelDTOOfCustAgingLineDTO"""
