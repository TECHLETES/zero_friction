...
class TestBulkSkipAdvancePeriodRequest(unittest.TestCase):
    """BulkSkipAdvancePeriodRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSkipAdvancePeriodRequest:
        """Test BulkSkipAdvancePeriodRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSkipAdvancePeriodRequest`
        """
        model = BulkSkipAdvancePeriodRequest()
        if include_optional:
            return BulkSkipAdvancePeriodRequest(
                only_validate = True,
    ...
    def testBulkSkipAdvancePeriodRequest(self):
        """Test BulkSkipAdvancePeriodRequest"""
