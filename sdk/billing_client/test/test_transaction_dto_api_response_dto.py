...
class TestTransactionDTOApiResponseDTO(unittest.TestCase):
    """TransactionDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionDTOApiResponseDTO:
        """Test TransactionDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionDTOApiResponseDTO`
        """
        model = TransactionDTOApiResponseDTO()
        if include_optional:
            return TransactionDTOApiResponseDTO(
                errors = [
    ...
    def testTransactionDTOApiResponseDTO(self):
        """Test TransactionDTOApiResponseDTO"""
