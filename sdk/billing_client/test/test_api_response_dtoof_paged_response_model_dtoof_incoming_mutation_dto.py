...
class TestApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO(unittest.TestCase):
    """ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO:
        """Test ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO`
        """
        model = ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO()
        if include_optional:
            return ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO(
                data = billing_client.models.paged_response_model_dtoof_incoming_mutation_dto.PagedResponseModelDTOOfIncomingMutationDTO(
                    results = [
    ...
    def testApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO(self):
        """Test ApiResponseDTOOfPagedResponseModelDTOOfIncomingMutationDTO"""
