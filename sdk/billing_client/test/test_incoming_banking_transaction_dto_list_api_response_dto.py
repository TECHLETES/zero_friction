...
class TestIncomingBankingTransactionDTOListApiResponseDTO(unittest.TestCase):
    """IncomingBankingTransactionDTOListApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingBankingTransactionDTOListApiResponseDTO:
        """Test IncomingBankingTransactionDTOListApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingBankingTransactionDTOListApiResponseDTO`
        """
        model = IncomingBankingTransactionDTOListApiResponseDTO()
        if include_optional:
            return IncomingBankingTransactionDTOListApiResponseDTO(
                errors = [
    ...
    def testIncomingBankingTransactionDTOListApiResponseDTO(self):
        """Test IncomingBankingTransactionDTOListApiResponseDTO"""
