...
class TestRequiredQuantityLocationGroupedDTO(unittest.TestCase):
    """RequiredQuantityLocationGroupedDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredQuantityLocationGroupedDTO:
        """Test RequiredQuantityLocationGroupedDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredQuantityLocationGroupedDTO`
        """
        model = RequiredQuantityLocationGroupedDTO()
        if include_optional:
    ...
    def testRequiredQuantityLocationGroupedDTO(self):
        """Test RequiredQuantityLocationGroupedDTO"""
