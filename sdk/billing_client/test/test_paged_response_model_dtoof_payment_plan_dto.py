...
class TestPagedResponseModelDTOOfPaymentPlanDTO(unittest.TestCase):
    """PagedResponseModelDTOOfPaymentPlanDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfPaymentPlanDTO:
        """Test PagedResponseModelDTOOfPaymentPlanDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfPaymentPlanDTO`
        """
        model = PagedResponseModelDTOOfPaymentPlanDTO()
        if include_optional:
            return PagedResponseModelDTOOfPaymentPlanDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfPaymentPlanDTO(self):
        """Test PagedResponseModelDTOOfPaymentPlanDTO"""
