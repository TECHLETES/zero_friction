...
class TestApiResponseDTOOfInvoiceDTO(unittest.TestCase):
    """ApiResponseDTOOfInvoiceDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfInvoiceDTO:
        """Test ApiResponseDTOOfInvoiceDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfInvoiceDTO`
        """
        model = ApiResponseDTOOfInvoiceDTO()
        if include_optional:
            return ApiResponseDTOOfInvoiceDTO(
    ...
    def testApiResponseDTOOfInvoiceDTO(self):
        """Test ApiResponseDTOOfInvoiceDTO"""
