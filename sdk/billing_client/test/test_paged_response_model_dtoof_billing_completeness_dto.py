...
class TestPagedResponseModelDTOOfBillingCompletenessDTO(unittest.TestCase):
    """PagedResponseModelDTOOfBillingCompletenessDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfBillingCompletenessDTO:
        """Test PagedResponseModelDTOOfBillingCompletenessDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfBillingCompletenessDTO`
        """
        model = PagedResponseModelDTOOfBillingCompletenessDTO()
        if include_optional:
            return PagedResponseModelDTOOfBillingCompletenessDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfBillingCompletenessDTO(self):
        """Test PagedResponseModelDTOOfBillingCompletenessDTO"""
