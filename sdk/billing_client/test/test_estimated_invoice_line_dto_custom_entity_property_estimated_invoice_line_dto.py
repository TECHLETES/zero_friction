...
class TestEstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO(unittest.TestCase):
    """EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO:
        """Test EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO`
        """
        model = EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO()
        if include_optional:
            return EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO(
                type = 'EstimatedInvoiceLineDTO:CustomEntityProperty',
    ...
    def testEstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO(self):
        """Test EstimatedInvoiceLineDTOCustomEntityPropertyEstimatedInvoiceLineDTO"""
