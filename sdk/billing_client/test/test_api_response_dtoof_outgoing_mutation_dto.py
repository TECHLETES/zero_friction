...
class TestApiResponseDTOOfOutgoingMutationDTO(unittest.TestCase):
    """ApiResponseDTOOfOutgoingMutationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfOutgoingMutationDTO:
        """Test ApiResponseDTOOfOutgoingMutationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfOutgoingMutationDTO`
        """
        model = ApiResponseDTOOfOutgoingMutationDTO()
        if include_optional:
            return ApiResponseDTOOfOutgoingMutationDTO(
    ...
    def testApiResponseDTOOfOutgoingMutationDTO(self):
        """Test ApiResponseDTOOfOutgoingMutationDTO"""
