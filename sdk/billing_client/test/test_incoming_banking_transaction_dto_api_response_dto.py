...
class TestIncomingBankingTransactionDTOApiResponseDTO(unittest.TestCase):
    """IncomingBankingTransactionDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingBankingTransactionDTOApiResponseDTO:
        """Test IncomingBankingTransactionDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingBankingTransactionDTOApiResponseDTO`
        """
        model = IncomingBankingTransactionDTOApiResponseDTO()
        if include_optional:
            return IncomingBankingTransactionDTOApiResponseDTO(
                errors = [
    ...
    def testIncomingBankingTransactionDTOApiResponseDTO(self):
        """Test IncomingBankingTransactionDTOApiResponseDTO"""
