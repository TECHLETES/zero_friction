...
class TestBulkRegenerateInvoiceRequest(unittest.TestCase):
    """BulkRegenerateInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkRegenerateInvoiceRequest:
        """Test BulkRegenerateInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkRegenerateInvoiceRequest`
        """
        model = BulkRegenerateInvoiceRequest()
        if include_optional:
            return BulkRegenerateInvoiceRequest(
                only_validate = True,
    ...
    def testBulkRegenerateInvoiceRequest(self):
        """Test BulkRegenerateInvoiceRequest"""
