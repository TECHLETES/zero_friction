...
class TestPaymentPlanDTO(unittest.TestCase):
    """PaymentPlanDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentPlanDTO:
        """Test PaymentPlanDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPlanDTO`
        """
        model = PaymentPlanDTO()
        if include_optional:
