...
class TestBulkMarkInvoiceSentSkippedRequest(unittest.TestCase):
    """BulkMarkInvoiceSentSkippedRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkMarkInvoiceSentSkippedRequest:
        """Test BulkMarkInvoiceSentSkippedRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkMarkInvoiceSentSkippedRequest`
        """
        model = BulkMarkInvoiceSentSkippedRequest()
        if include_optional:
            return BulkMarkInvoiceSentSkippedRequest(
                only_validate = True,
    ...
    def testBulkMarkInvoiceSentSkippedRequest(self):
        """Test BulkMarkInvoiceSentSkippedRequest"""
