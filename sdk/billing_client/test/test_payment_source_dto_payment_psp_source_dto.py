...
class TestPaymentSourceDTOPaymentPspSourceDTO(unittest.TestCase):
    """PaymentSourceDTOPaymentPspSourceDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentSourceDTOPaymentPspSourceDTO:
        """Test PaymentSourceDTOPaymentPspSourceDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentSourceDTOPaymentPspSourceDTO`
        """
        model = PaymentSourceDTOPaymentPspSourceDTO()
        if include_optional:
            return PaymentSourceDTOPaymentPspSourceDTO(
    ...
    def testPaymentSourceDTOPaymentPspSourceDTO(self):
        """Test PaymentSourceDTOPaymentPspSourceDTO"""
