...
class TestCollectionCaseDTOApiResponseDTO(unittest.TestCase):
    """CollectionCaseDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionCaseDTOApiResponseDTO:
        """Test CollectionCaseDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionCaseDTOApiResponseDTO`
        """
        model = CollectionCaseDTOApiResponseDTO()
        if include_optional:
            return CollectionCaseDTOApiResponseDTO(
                errors = [
    ...
    def testCollectionCaseDTOApiResponseDTO(self):
        """Test CollectionCaseDTOApiResponseDTO"""
