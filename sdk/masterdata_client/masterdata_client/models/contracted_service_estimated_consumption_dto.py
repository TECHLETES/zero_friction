...
class ContractedServiceEstimatedConsumptionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["consumerGroupId", "consumptionQuantity", "unitOfMeasure", "meteringType", "direction"]
