...
class PagedProjectCodeMappingQueryParams(BaseModel):
    """
    PagedProjectCodeMappingQueryParams
    """ # noqa: E501
    name: Optional[StrictStr] = None
    accounting_code: Optional[StrictStr] = Field(default=None, alias="accountingCode")
    category: Optional[ProjectCodeCategory] = None
    only_unlinked: Optional[StrictBool] = Field(default=None, alias="onlyUnlinked")
    ...
    __properties: ClassVar[List[str]] = ["name", "accountingCode", "category", "onlyUnlinked", "flexSearch", "includeOnlyIds", "excludeIds", "pageSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "onlyUnlinked": obj.get("onlyUnlinked"),
