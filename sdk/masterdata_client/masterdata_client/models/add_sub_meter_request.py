...
class AddSubMeterRequest(BaseModel):
    """
    AddSubMeterRequest
    """ # noqa: E501
    sub_meter_id: Optional[StrictStr] = Field(default=None, alias="subMeterId")
    external_reference: Optional[StrictStr] = Field(default=None, alias="externalReference")
    __properties: ClassVar[List[str]] = ["subMeterId", "externalReference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sub_meter_id (nullable) is None
        # and model_fields_set contains the field
        if self.sub_meter_id is None and "sub_meter_id" in self.model_fields_set:
            _dict['subMeterId'] = None
