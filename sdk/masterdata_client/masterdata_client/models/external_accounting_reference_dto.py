...
class ExternalAccountingReferenceDTO(BaseModel):
    """
    ExternalAccountingReferenceDTO
    """ # noqa: E501
    source_entity_id: StrictStr = Field(alias="sourceEntityId")
    source_accounting_company_id: StrictStr = Field(alias="sourceAccountingCompanyId")
    __properties: ClassVar[List[str]] = ["sourceEntityId", "sourceAccountingCompanyId"]
