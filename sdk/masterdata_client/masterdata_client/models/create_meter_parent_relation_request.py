...
class CreateMeterParentRelationRequest(BaseModel):
    """
    CreateMeterParentRelationRequest
    """ # noqa: E501
    parent_meter_id: Optional[StrictStr] = Field(default=None, alias="parentMeterId")
    external_reference: Optional[StrictStr] = Field(default=None, alias="externalReference")
    __properties: ClassVar[List[str]] = ["parentMeterId", "externalReference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_meter_id (nullable) is None
        # and model_fields_set contains the field
        if self.parent_meter_id is None and "parent_meter_id" in self.model_fields_set:
            _dict['parentMeterId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parentMeterId": obj.get("parentMeterId"),
