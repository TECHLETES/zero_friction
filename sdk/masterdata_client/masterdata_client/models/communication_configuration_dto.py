...
class CommunicationConfigurationDTO(BaseModel):
    """
    ...
    contact_details: Optional[PropertyGroupContactDetailsDTO] = Field(default=None, alias="contactDetails")
    __properties: ClassVar[List[str]] = ["companyName", "vatAccountNumber", "companyAccountNumber", "logo", "logoCdnUrl", "primaryColor", "secondaryColor", "address", "contactDetails"]
