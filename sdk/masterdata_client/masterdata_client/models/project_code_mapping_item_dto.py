...
class ProjectCodeMappingItemDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "accountingCode", "accountingStatus", "serviceLocationIds", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
