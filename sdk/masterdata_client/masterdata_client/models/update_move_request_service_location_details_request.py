...
class UpdateMoveRequestServiceLocationDetailsRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [MoveRequestServiceLocationServiceDetailsRequest.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None,
