...
class BulkReconfigureMeterFromModelRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "mutationDateTime", "modelId", "useBeginningOfMeter"]
