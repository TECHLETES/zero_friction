...
class UpdateServiceLocationServicesRequest(BaseModel):
    """
    UpdateServiceLocationServicesRequest
    """ # noqa: E501
    services_to_add: List[UtilityType] = Field(alias="servicesToAdd")
    services_to_remove: List[UtilityType] = Field(alias="servicesToRemove")
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[GetServiceLocationsQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    __properties: ClassVar[List[str]] = ["servicesToAdd", "servicesToRemove", "onlyValidate", "queryParams", "quickFilter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "servicesToAdd": obj.get("servicesToAdd"),
            "servicesToRemove": obj.get("servicesToRemove"),
            "onlyValidate": obj.get("onlyValidate"),
            "queryParams": GetServiceLocationsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
