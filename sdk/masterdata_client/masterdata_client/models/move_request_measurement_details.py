...
class MoveRequestMeasurementDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["internalMeterId", "externalChannelIdentifier", "meterSerialNumber", "utilityType", "unitOfMeasure", "timeOfUse", "value"]
