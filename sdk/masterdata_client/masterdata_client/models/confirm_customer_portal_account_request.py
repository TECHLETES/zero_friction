...
class ConfirmCustomerPortalAccountRequest(BaseModel):
    """
    ConfirmCustomerPortalAccountRequest
    """ # noqa: E501
    confirm_account_token: Optional[StrictStr] = Field(alias="confirmAccountToken")
    __properties: ClassVar[List[str]] = ["confirmAccountToken"]
