...
class UpdateContractBillingMethodRequest(BaseModel):
    """
    UpdateContractBillingMethodRequest
    """ # noqa: E501
    billing_method: ContractBillingMethod = Field(alias="billingMethod")
    effective_start_date: datetime = Field(alias="effectiveStartDate")
    __properties: ClassVar[List[str]] = ["billingMethod", "effectiveStartDate"]
