...
class ManagementRelationDTO2(BaseModel):
    """
    ...
    management_relation_type: Optional[ManagementRelationType] = Field(default=None, alias="managementRelationType")
    __properties: ClassVar[List[str]] = ["customerId", "shortDisplayName", "accountNumber", "managementRelationType"]
