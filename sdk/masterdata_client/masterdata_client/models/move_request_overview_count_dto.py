...
class MoveRequestOverviewCountDTO(BaseModel):
    """
    ...
    to_be_processed: Optional[StrictInt] = Field(default=None, alias="toBeProcessed")
    __properties: ClassVar[List[str]] = ["all", "new", "pending", "processed", "rejected", "toBeProcessed"]
