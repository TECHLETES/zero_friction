...
class CreateContractBillingPropertiesBaseRequestCreateContractBillingPropertiesCreditRequest(BaseModel):
    """
    ...
    contractual_advance_amount: Union[StrictFloat, StrictInt] = Field(alias="contractualAdvanceAmount")
    ...
    __properties: ClassVar[List[str]] = ["type", "invoiceFrequency", "advanceFrequency", "contractualAdvanceAmount", "firstInvoiceStartDateTime", "firstInvoiceEndDateTime", "paymentTermsId", "expectAdvancesToBeImportedPeriodically", "deviatingFirstAdvanceStartDate", "advanceCalculationType", "advancePeriodPercentages"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CreateContractBillingPropertiesCreditRequest']):
            raise ValueError("must be one of enum values ('CreateContractBillingPropertiesCreditRequest')")
        return value
