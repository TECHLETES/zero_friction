...
class BulkLinkItemCodesRequest(BaseModel):
    """
    BulkLinkItemCodesRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[PagedItemCodeMappingQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    item_code_id: Optional[StrictStr] = Field(default=None, alias="itemCodeId")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "itemCodeId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if item_code_id (nullable) is None
        # and model_fields_set contains the field
        if self.item_code_id is None and "item_code_id" in self.model_fields_set:
            _dict['itemCodeId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": PagedItemCodeMappingQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
            "quickFilter": obj.get("quickFilter"),
            "itemCodeId": obj.get("itemCodeId")
        })
        return _obj
