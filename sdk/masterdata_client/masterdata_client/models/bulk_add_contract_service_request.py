...
class BulkAddContractServiceRequest(BaseModel):
    """
    ...
    estimated_consumption: Optional[AddContractServiceEstimatedConsumptionRequest] = Field(alias="estimatedConsumption")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "utilityType", "estimatedConsumption"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of estimated_consumption
        if self.estimated_consumption:
            _dict['estimatedConsumption'] = self.estimated_consumption.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimatedConsumption": AddContractServiceEstimatedConsumptionRequest.from_dict(obj["estimatedConsumption"]) if obj.get("estimatedConsumption") is not None else None
        })
        return _obj
