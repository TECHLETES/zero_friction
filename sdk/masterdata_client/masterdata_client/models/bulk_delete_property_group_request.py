...
class BulkDeletePropertyGroupRequest(BaseModel):
    """
    ...
    var_query_params: Optional[GetPropertyGroupsQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    __properties: ClassVar[List[str]] = ["mutationDateTime", "onlyValidate", "queryParams", "quickFilter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetPropertyGroupsQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
