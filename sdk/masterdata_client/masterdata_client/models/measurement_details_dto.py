...
class MeasurementDetailsDTO(BaseModel):
    """
    MeasurementDetailsDTO
    """ # noqa: E501
    internal_meter_id: Optional[StrictStr] = Field(default=None, alias="internalMeterId")
    ...
    __properties: ClassVar[List[str]] = ["internalMeterId", "externalChannelIdentifier", "meterSerialNumber", "utilityType", "unitOfMeasure", "timeOfUse", "value", "timeZone", "errors"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.errors:
            ...
            _dict['errors'] = _items
        # set to None if internal_meter_id (nullable) is None
        # and model_fields_set contains the field
        if self.internal_meter_id is None and "internal_meter_id" in self.model_fields_set:
            _dict['internalMeterId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "internalMeterId": obj.get("internalMeterId"),
