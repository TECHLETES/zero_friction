...
class BulkSignContractRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "mutationDateTime", "keepExistingInvoiceOnEndDate", "createBillingCompletenessesFromExistingInvoices"]
