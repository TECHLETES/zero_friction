...
class CostUnitMappingOverviewCountResponseDTO(BaseModel):
    """
    CostUnitMappingOverviewCountResponseDTO
    """ # noqa: E501
    customer_groups: Optional[StrictInt] = Field(default=None, alias="customerGroups")
    __properties: ClassVar[List[str]] = ["customerGroups"]
