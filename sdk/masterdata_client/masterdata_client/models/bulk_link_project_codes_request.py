...
class BulkLinkProjectCodesRequest(BaseModel):
    """
    BulkLinkProjectCodesRequest
    """ # noqa: E501
    only_validate: Optional[StrictBool] = Field(default=None, alias="onlyValidate")
    var_query_params: Optional[PagedProjectCodeMappingQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    project_code_id: Optional[StrictStr] = Field(default=None, alias="projectCodeId")
    __properties: ClassVar[List[str]] = ["onlyValidate", "queryParams", "quickFilter", "projectCodeId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if project_code_id (nullable) is None
        # and model_fields_set contains the field
        if self.project_code_id is None and "project_code_id" in self.model_fields_set:
            _dict['projectCodeId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": PagedProjectCodeMappingQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
            "quickFilter": obj.get("quickFilter"),
            "projectCodeId": obj.get("projectCodeId")
        })
        return _obj
