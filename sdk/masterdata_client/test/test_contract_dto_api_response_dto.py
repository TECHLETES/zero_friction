...
class TestContractDTOApiResponseDTO(unittest.TestCase):
    """ContractDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractDTOApiResponseDTO:
        """Test ContractDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractDTOApiResponseDTO`
        """
        model = ContractDTOApiResponseDTO()
        if include_optional:
            return ContractDTOApiResponseDTO(
                errors = [
    ...
    def testContractDTOApiResponseDTO(self):
        """Test ContractDTOApiResponseDTO"""
