...
class TestPagedResponseModelDTOOfContractDTO(unittest.TestCase):
    """PagedResponseModelDTOOfContractDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfContractDTO:
        """Test PagedResponseModelDTOOfContractDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfContractDTO`
        """
        model = PagedResponseModelDTOOfContractDTO()
        if include_optional:
            return PagedResponseModelDTOOfContractDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfContractDTO(self):
        """Test PagedResponseModelDTOOfContractDTO"""
