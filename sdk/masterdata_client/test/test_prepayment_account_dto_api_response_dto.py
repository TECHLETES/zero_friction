...
class TestPrepaymentAccountDTOApiResponseDTO(unittest.TestCase):
    """PrepaymentAccountDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrepaymentAccountDTOApiResponseDTO:
        """Test PrepaymentAccountDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrepaymentAccountDTOApiResponseDTO`
        """
        model = PrepaymentAccountDTOApiResponseDTO()
        if include_optional:
            return PrepaymentAccountDTOApiResponseDTO(
                errors = [
                ...
                is_synchronous = True,
                data = masterdata_client.models.prepayment_account_dto.PrepaymentAccountDTO(
                    id = '', 
                    entity_type = null, 
    ...
    def testPrepaymentAccountDTOApiResponseDTO(self):
        """Test PrepaymentAccountDTOApiResponseDTO"""
