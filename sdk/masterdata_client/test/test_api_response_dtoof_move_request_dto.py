...
class TestApiResponseDTOOfMoveRequestDTO(unittest.TestCase):
    """ApiResponseDTOOfMoveRequestDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfMoveRequestDTO:
        """Test ApiResponseDTOOfMoveRequestDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfMoveRequestDTO`
        """
        model = ApiResponseDTOOfMoveRequestDTO()
        if include_optional:
            return ApiResponseDTOOfMoveRequestDTO(
    ...
    def testApiResponseDTOOfMoveRequestDTO(self):
        """Test ApiResponseDTOOfMoveRequestDTO"""
