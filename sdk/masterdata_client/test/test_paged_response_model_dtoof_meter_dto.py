...
class TestPagedResponseModelDTOOfMeterDTO(unittest.TestCase):
    """PagedResponseModelDTOOfMeterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfMeterDTO:
        """Test PagedResponseModelDTOOfMeterDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfMeterDTO`
        """
        model = PagedResponseModelDTOOfMeterDTO()
        if include_optional:
            return PagedResponseModelDTOOfMeterDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfMeterDTO(self):
        """Test PagedResponseModelDTOOfMeterDTO"""
