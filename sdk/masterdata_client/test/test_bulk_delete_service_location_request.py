...
class TestBulkDeleteServiceLocationRequest(unittest.TestCase):
    """BulkDeleteServiceLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDeleteServiceLocationRequest:
        """Test BulkDeleteServiceLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDeleteServiceLocationRequest`
        """
        model = BulkDeleteServiceLocationRequest()
        if include_optional:
    ...
    def testBulkDeleteServiceLocationRequest(self):
        """Test BulkDeleteServiceLocationRequest"""
