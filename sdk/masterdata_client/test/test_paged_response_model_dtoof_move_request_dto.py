...
class TestPagedResponseModelDTOOfMoveRequestDTO(unittest.TestCase):
    """PagedResponseModelDTOOfMoveRequestDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfMoveRequestDTO:
        """Test PagedResponseModelDTOOfMoveRequestDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfMoveRequestDTO`
        """
        model = PagedResponseModelDTOOfMoveRequestDTO()
        if include_optional:
            return PagedResponseModelDTOOfMoveRequestDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfMoveRequestDTO(self):
        """Test PagedResponseModelDTOOfMoveRequestDTO"""
