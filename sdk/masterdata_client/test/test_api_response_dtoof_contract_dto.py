...
class TestApiResponseDTOOfContractDTO(unittest.TestCase):
    """ApiResponseDTOOfContractDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfContractDTO:
        """Test ApiResponseDTOOfContractDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfContractDTO`
        """
        model = ApiResponseDTOOfContractDTO()
        if include_optional:
            return ApiResponseDTOOfContractDTO(
                data = masterdata_client.models.contract_dto.ContractDTO(
                    contract_number = '', 
    ...
    def testApiResponseDTOOfContractDTO(self):
        """Test ApiResponseDTOOfContractDTO"""
