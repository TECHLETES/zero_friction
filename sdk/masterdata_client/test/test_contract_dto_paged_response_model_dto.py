...
class TestContractDTOPagedResponseModelDTO(unittest.TestCase):
    """ContractDTOPagedResponseModelDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContractDTOPagedResponseModelDTO:
        """Test ContractDTOPagedResponseModelDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContractDTOPagedResponseModelDTO`
        """
        model = ContractDTOPagedResponseModelDTO()
        if include_optional:
            return ContractDTOPagedResponseModelDTO(
                results = [
    ...
    def testContractDTOPagedResponseModelDTO(self):
        """Test ContractDTOPagedResponseModelDTO"""
