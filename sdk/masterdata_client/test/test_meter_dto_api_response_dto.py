...
class TestMeterDTOApiResponseDTO(unittest.TestCase):
    """MeterDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeterDTOApiResponseDTO:
        """Test MeterDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeterDTOApiResponseDTO`
        """
        model = MeterDTOApiResponseDTO()
        if include_optional:
            return MeterDTOApiResponseDTO(
                errors = [
    ...
    def testMeterDTOApiResponseDTO(self):
        """Test MeterDTOApiResponseDTO"""
