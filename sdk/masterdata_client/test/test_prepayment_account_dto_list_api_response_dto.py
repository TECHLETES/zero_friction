...
class TestPrepaymentAccountDTOListApiResponseDTO(unittest.TestCase):
    """PrepaymentAccountDTOListApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrepaymentAccountDTOListApiResponseDTO:
        """Test PrepaymentAccountDTOListApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrepaymentAccountDTOListApiResponseDTO`
        """
        model = PrepaymentAccountDTOListApiResponseDTO()
        if include_optional:
            return PrepaymentAccountDTOListApiResponseDTO(
                errors = [
    ...
    def testPrepaymentAccountDTOListApiResponseDTO(self):
        """Test PrepaymentAccountDTOListApiResponseDTO"""
