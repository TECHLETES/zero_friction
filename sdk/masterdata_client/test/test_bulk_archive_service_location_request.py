...
class TestBulkArchiveServiceLocationRequest(unittest.TestCase):
    """BulkArchiveServiceLocationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkArchiveServiceLocationRequest:
        """Test BulkArchiveServiceLocationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkArchiveServiceLocationRequest`
        """
        model = BulkArchiveServiceLocationRequest()
        if include_optional:
            return BulkArchiveServiceLocationRequest(
                only_validate = True,
    ...
    def testBulkArchiveServiceLocationRequest(self):
        """Test BulkArchiveServiceLocationRequest"""
