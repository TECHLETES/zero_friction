...
class TestBulkSignContractRequest(unittest.TestCase):
    """BulkSignContractRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkSignContractRequest:
        """Test BulkSignContractRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkSignContractRequest`
        """
    ...
    def testBulkSignContractRequest(self):
        """Test BulkSignContractRequest"""
