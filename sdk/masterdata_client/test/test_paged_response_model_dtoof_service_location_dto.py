...
class TestPagedResponseModelDTOOfServiceLocationDTO(unittest.TestCase):
    """PagedResponseModelDTOOfServiceLocationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagedResponseModelDTOOfServiceLocationDTO:
        """Test PagedResponseModelDTOOfServiceLocationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagedResponseModelDTOOfServiceLocationDTO`
        """
        model = PagedResponseModelDTOOfServiceLocationDTO()
        if include_optional:
            return PagedResponseModelDTOOfServiceLocationDTO(
                results = [
    ...
    def testPagedResponseModelDTOOfServiceLocationDTO(self):
        """Test PagedResponseModelDTOOfServiceLocationDTO"""
