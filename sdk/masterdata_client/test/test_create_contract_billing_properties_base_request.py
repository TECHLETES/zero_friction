...
class TestCreateContractBillingPropertiesBaseRequest(unittest.TestCase):
    """CreateContractBillingPropertiesBaseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateContractBillingPropertiesBaseRequest:
        """Test CreateContractBillingPropertiesBaseRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateContractBillingPropertiesBaseRequest`
        """
        model = CreateContractBillingPropertiesBaseRequest()
        if include_optional:
            return CreateContractBillingPropertiesBaseRequest(
    ...
    def testCreateContractBillingPropertiesBaseRequest(self):
        """Test CreateContractBillingPropertiesBaseRequest"""
