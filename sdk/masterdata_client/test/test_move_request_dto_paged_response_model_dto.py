...
class TestMoveRequestDTOPagedResponseModelDTO(unittest.TestCase):
    """MoveRequestDTOPagedResponseModelDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MoveRequestDTOPagedResponseModelDTO:
        """Test MoveRequestDTOPagedResponseModelDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MoveRequestDTOPagedResponseModelDTO`
        """
        model = MoveRequestDTOPagedResponseModelDTO()
        if include_optional:
            return MoveRequestDTOPagedResponseModelDTO(
                results = [
    ...
    def testMoveRequestDTOPagedResponseModelDTO(self):
        """Test MoveRequestDTOPagedResponseModelDTO"""
