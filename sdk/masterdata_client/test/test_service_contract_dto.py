...
class TestServiceContractDTO(unittest.TestCase):
    """ServiceContractDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceContractDTO:
        """Test ServiceContractDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceContractDTO`
        """
        model = ServiceContractDTO()
        if include_optional:
    ...
    def testServiceContractDTO(self):
        """Test ServiceContractDTO"""
