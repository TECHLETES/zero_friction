...
class TestServiceLocationDTOApiResponseDTO(unittest.TestCase):
    """ServiceLocationDTOApiResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceLocationDTOApiResponseDTO:
        """Test ServiceLocationDTOApiResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceLocationDTOApiResponseDTO`
        """
        model = ServiceLocationDTOApiResponseDTO()
        if include_optional:
            return ServiceLocationDTOApiResponseDTO(
                errors = [
    ...
    def testServiceLocationDTOApiResponseDTO(self):
        """Test ServiceLocationDTOApiResponseDTO"""
