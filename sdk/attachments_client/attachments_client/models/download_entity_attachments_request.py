...
class DownloadEntityAttachmentsRequest(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if entity_attachment_ids (nullable) is None
        # and model_fields_set contains the field
        if self.entity_attachment_ids is None and "entity_attachment_ids" in self.model_fields_set:
            _dict['entityAttachmentIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entityAttachmentIds": obj.get("entityAttachmentIds"),
