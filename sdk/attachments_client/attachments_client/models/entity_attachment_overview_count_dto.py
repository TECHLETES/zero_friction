...
class EntityAttachmentOverviewCountDTO(BaseModel):
    """
    EntityAttachmentOverviewCountDTO
    """ # noqa: E501
    all: Optional[StrictInt] = None
    visible_for_customer: Optional[StrictInt] = Field(default=None, alias="visibleForCustomer")
    __properties: ClassVar[List[str]] = ["all", "visibleForCustomer"]
