...
class AttachmentDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "subjectType", "userId", "fileName", "internalFilePath", "organisationId", "id", "entityType", "createdDateTime", "discriminator", "_etag", "hasErrors", "isReadOnly"]
