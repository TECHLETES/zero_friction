...
class BulkDeleteEntityAttachmentRequest(BaseModel):
    """
    ...
    var_query_params: Optional[GetEntityAttachmentQueryParams] = Field(default=None, alias="queryParams")
    quick_filter: Optional[StrictStr] = Field(default=None, alias="quickFilter")
    __properties: ClassVar[List[str]] = ["customerId", "onlyValidate", "queryParams", "quickFilter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryParams": GetEntityAttachmentQueryParams.from_dict(obj["queryParams"]) if obj.get("queryParams") is not None else None,
