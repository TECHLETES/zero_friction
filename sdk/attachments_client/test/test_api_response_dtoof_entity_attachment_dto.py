...
class TestApiResponseDTOOfEntityAttachmentDTO(unittest.TestCase):
    """ApiResponseDTOOfEntityAttachmentDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfEntityAttachmentDTO:
        """Test ApiResponseDTOOfEntityAttachmentDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfEntityAttachmentDTO`
        """
        model = ApiResponseDTOOfEntityAttachmentDTO()
        if include_optional:
            return ApiResponseDTOOfEntityAttachmentDTO(
    ...
    def testApiResponseDTOOfEntityAttachmentDTO(self):
        """Test ApiResponseDTOOfEntityAttachmentDTO"""
