...
class TestApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO(unittest.TestCase):
    """ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO:
        """Test ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO`
        """
        model = ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO()
        if include_optional:
            return ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO(
                data = attachments_client.models.paged_response_model_dtoof_entity_attachment_dto.PagedResponseModelDTOOfEntityAttachmentDTO(
                    results = [
    ...
    def testApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO(self):
        """Test ApiResponseDTOOfPagedResponseModelDTOOfEntityAttachmentDTO"""
